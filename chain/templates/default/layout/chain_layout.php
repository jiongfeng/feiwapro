...
<header class="ncsc-head-layout w">
  <div class="wrapper">
    ...
    <ul class="ncsc-nav">
      <li> <a href="index.php?app=goods" class="<?php echo $_GET['app'] == 'goods'?'current':'';?>">门店商品库存</a> </li>
      <li> <a href="index.php?app=order" class="<?php echo $_GET['app'] == 'order'?'current':'';?>">门店取货订单</a> </li>
