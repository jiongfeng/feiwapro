...
<div class="theme-top clearfix">
  ...
  <div class="contnet theme-list">
    ...
    <?php foreach ($output['new_themelist'] as $val){?>
      <li>
        <a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=theme&feiwa=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>"class="theme-title" title="<?php echo $val['theme_name'];?>"><?php echo $val['theme_name'];?></a>
        <a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['circle_id'];?>" class="group-name" title="<?php echo $lang['circle_theme_come_from'].$lang['feiwa_colon'].$val['circle_name'];?>"><?php echo $val['circle_name'];?></a>
      </li>
    <?php }?>
    </ul>
    <?php }?>
