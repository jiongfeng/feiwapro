...
<div class="base-tab-menu">
  <dl class="my-manage">
    <dt class="group-name"><strong><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=group&c_id=<?php echo $output['c_id'];?>"><?php echo $output['circle_info']['circle_name'];?></a></strong>[<?php echo $lang['circle_management_center'];?>]</dt>
