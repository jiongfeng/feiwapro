...
<div class="search-page">
  ...
  <?php if(!empty($output['circle_list'])){?>
    ...
    <?php foreach($output['circle_list'] as $val){?>
      <li>
        <dl class="group-info">
          <dt class="group-name"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name']?></a></dt>
          <dd class="group-pic"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['circle_id'];?>"><img src="<?php echo circleLogo($val['circle_id']);?>" /></a></dd>
    ...
    <div class="no-theme">
      <i></i>
      <span><?php echo $lang['circle_result_null'].L('feiwa_comma,circle_go');?><a href="<?php echo CIRCLE_SITE_URL;?>"><?php echo L('circle_home_page_around');?></a></span>
      <br>
      <span><?php echo $lang['circle_search_null_msg'];?><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=index&feiwa=add_group&kw=<?php echo $_GET['keyword'];?>"><?php echo $lang['circle_instantly_create'];?></a></span>
    </div>
    <div></div>
    <?php }?>
  </div></div>
