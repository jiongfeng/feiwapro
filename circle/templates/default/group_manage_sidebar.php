...
<div class="my-info">
  <div class="avatar"><img src="<?php echo getMemberAvatarForID($_SESSION['member_id']);?>" /><a href="<?php echo urlMember('member_information', 'avatar');?>" title="<?php echo $lang['feiwa_edit_avatar'];?>"><?php echo $lang['feiwa_edit_avatar'];?></a></div>
  <dl>
    <dt>
      <h2><a href="index.php?app=p_center" target="_blank"><?php echo $_SESSION['member_name'];?></a></h2>
    </dt>
    <dd><span><?php echo $lang['circle_theme'].$lang['feiwa_colon'];?><em>(<b><?php echo $output['cm_info']['cm_thcount'];?></b>)</em></span><span><?php echo $lang['circle_reply'].$lang['feiwa_colon'];?><em>(<b><?php echo $output['cm_info']['cm_comcount'];?></b>)</em></span></dd>
  </dl>
</div>
<div class="side-tab-nav">
  ...
  <div class="my-circle-list tabs-panel">
    ...
    <dl <?php if($val['is_identity'] == 3){?>nctype="member"<?php }?>>
      <dt class="name"><a href="<?php echo CIRCLE_SITE_URL;?>/index.php?app=group&c_id=<?php echo $val['circle_id'];?>" title="<?php echo $val['circle_name'];?>" ><?php echo $val['circle_name'];?></a></dt>
