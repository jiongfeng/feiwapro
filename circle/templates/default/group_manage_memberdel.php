...
<div class="eject_con">
<form method="post" id="delmember" name="delmember" action="<?php echo CIRCLE_SITE_URL;?>/index.php?app=manage&feiwa=delmember&c_id=<?php echo $_GET['c_id'];?>&cm_id=<?php echo $_GET['cm_id'];?>">
    <input type="hidden" name="form_submit" value="ok"/>
    <dl><dd><p><?php echo $lang['feiwa_ensure_del'];?></p></dd></dl>
    <dl>
      <dd>
