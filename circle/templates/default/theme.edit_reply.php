...
<div class="group warp-all">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo CIRCLE_SITE_URL;?>/index.php?app=theme&feiwa=edit_reply&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['reply_info']['theme_id'];?>&r_id=<?php echo $output['reply_info']['reply_id'];?>">
      ...
      <div class="quick-thread">
        <div class="quick-thread-box">
          ...
          <div class="bottom"> <a class="submit-btn" nctype="reply_submit" href="Javascript: void(0)"><?php echo $lang['feiwa_edit_reply'];?></a> <a class="cancel-btn" href="Javascript:history.go(-1);" nctype="theme_cancle"><?php echo $lang['feiwa_cancel'];?></a>
            <div id="warning"></div>
          </div>
        </div>
      </div>
...
$(function(){
	$('.theme-editor').ncUBB({
		...
		UBBform : $('#reply_form1'),
		UBBfileuploadurl : 'index.php?app=theme&feiwa=image_upload&c_id='+c_id+'&type=reply',
