...
<div class="community-wrap">
  ...
  <div class="theme-editor">
    <form method="post" id="reply_form1" action="<?php echo CIRCLE_SITE_URL;?>/index.php?app=theme&feiwa=save_reply&type=adv&c_id=<?php echo $output['c_id'];?>&t_id=<?php echo $output['t_id'];?>">
      ...
      <div class="quick-thread">
        <div class="quick-thread-box">
          ...
          <div class="bottom"> <a class="submit-btn" nctype="reply_submit" href="Javascript: void(0)"><?php echo $lang['feiwa_reply_theme'];?></a> <a class="cancel-btn" href="Javascript:history.go(-1);" nctype="theme_cancle"><?php echo $lang['feiwa_cancel'];?></a>
            <div id="warning"></div>
          </div>
        </div>
      </div>
...
$(function(){
    ...
    $('#reply_form1').validate({
    	...
    	submitHandler:function(form){
    		ajaxpost('reply_form1', CIRCLE_SITE_URL+'/index.php?app=theme&feiwa=save_reply&c_id='+c_id+'&t_id='+t_id, '', 'onerror');
    	},
        rules : {
        	replycontent : {
                required : true
