...
<div class="ncd-joinin">
  <h1>物流自提服务站加盟</h1>
  <form id="delivery_joinin" method="post" enctype="multipart/form-data" action="<?php echo DELIVERY_SITE_URL?>/index.php?app=joinin&feiwa=save_delivery">
    ...
    <div style="text-align: center; padding: 10px 0;">
      ...
      <a href="index.php?app=login" class="login">已注册用户"登录管理"</a>
    </div>
  </form>
</div>
    ...
    $('#delivery_joinin').validate({
        ...
        rules : {
            dname : {
                ...
                rangelength : [3,15],
                lettersonly : true,
                remote   : 'index.php?app=joinin&feiwa=check'
            },
            dpasswd : {
                required : true,
                rangelength : [6,20]
