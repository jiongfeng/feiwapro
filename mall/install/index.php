...
<div class="header">
  <div class="layout">
    ...
    <div class="version">版本: 20170308017_1.4.0</div>
  </div>
</div>
...
<div class="footer">
  ...
  <h6>版权所有 2013-2016 &copy; <a href="http://www.feiwa.org" target="_blank">FeiWa官方</a></h6>
...
switch ($_GET['step']) {
    ...
    case 5:
        ...
        $sitepath = str_replace('/mall/install',"",$sitepath);
...
function step3(&$install_error,&$install_recover){
    ...
    $sql .= "\r\n".file_get_contents("data/{$_charset}_reads.sql");
    $sql .= "\r\n".file_get_contents("data/{$_charset}_circle.sql");
    $sql .= "\r\n".file_get_contents("data/{$_charset}_shareshow.sql");
    if (file_exists('../../mo_bile/readme/sql/mobile.sql')) {
        $sql .= "\r\n".file_get_contents("../../mo_bile/readme/sql/mobile.sql");
    }
    ...
    $mysqli->query("INSERT INTO {$db_prefix}store (`store_id`, `store_name`, `grade_id`, `member_id`, `member_name`, `seller_name`, `sc_id`, `store_company_name`, `province_id`, `area_info`, `store_address`, `store_zip`, `store_state`, `store_close_info`, `store_sort`, `store_time`, `store_end_time`, `store_label`, `store_banner`, `store_avatar`, `store_keywords`, `store_description`, `store_qq`, `store_ww`, `store_phone`, `store_zy`, `store_domain`, `store_domain_times`, `store_recommend`, `store_theme`, `store_credit`, `store_desccredit`, `store_servicecredit`, `store_deliverycredit`, `store_collect`, `store_slide`, `store_slide_url`, `store_stamp`, `store_printdesc`, `store_sales`, `store_presales`, `store_aftersales`, `store_workingtime`, `store_free_price`, `store_decoration_switch`, `store_decoration_only`, `store_decoration_image_count`, `is_own_mall`, `bind_all_gc`, `store_vrcode_prefix`, `mb_title_img`, `mb_sliders`, `left_bar_type`, `deliver_region`, `is_distribution`) VALUES (1, '{$store_name}', 0, 1, '{$member_name}', '{$seller_name}', 0, NULL, 0, '', '', '', 1, NULL, 0, '". time() ."', NULL, NULL, NULL, NULL, '', '', NULL, NULL, NULL, NULL, NULL, 0, 0, 'default', 0, 0, 0, 0, 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, '0.00', 0, 0, 0, 1, 1, NULL, NULL, NULL, 1, NULL, 0)");
