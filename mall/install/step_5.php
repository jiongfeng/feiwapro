...
<div class="main">
  ...
  <div class="final-site-nav">
    ...
    <ul>
      <li class="shop">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/mall" target="_blank">商城</a></h5>
        <h6>线上购物、开店、交易...</h6>
      </li>
      <li class="cms">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/reads" target="_blank">淘资讯</a></h5>
        <h6>CMS文章系统资讯、画报、专题...</h6>
      </li>
      <li class="circle">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/circle" target="_blank">淘友圈</a></h5>
        <h6>主题、圈友、商品...</h6>
      </li>
      <li class="microshop">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/shareshow" target="_blank">分享秀</a></h5>
        <h6>随心看、个人秀、店铺街</h6>
      </li>
      <li class="admin">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/admin_feiwa" target="_blank">系统管理</a></h5>
        <h6>电商系统后台</h6>
      </li>
    </ul>
  </div>
