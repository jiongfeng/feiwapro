...
<ul class="cart-list">
  ...
  <li ncTpye="cart_item_<?php echo $v['cart_id'];?>">
    <div class="goods-pic"><a href="<?php echo urlMall('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank";><img src="<?php echo $v['goods_image'];?>" alt="<?php echo $v['goods_name'];?>"/></a></div>
    <dl>
      <dt class="goods-name"><a href="<?php echo urlMall('goods','index',array('goods_id'=>$v['goods_id']));?>" title="<?php echo $v['goods_name'];?>" target="_blank";><?php echo $v['goods_name'];?></a></dt>
...
<a href="javascript:void(0);" onclick="javascript:window.location.href='<?php echo MALL_SITE_URL;?>/index.php?app=cart'">结算购物车中的商品</a>
<?php } ?>