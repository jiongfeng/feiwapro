...
<div class="ncc-receipt-info"><div class="ncc-receipt-info-title">
  <h3>发票信息</h3>
  <a href="javascript:void(0)" feiwa_type="buy_edit" id="edit_invoice">[修改]</a></div>
...
$('#edit_invoice').on('click',function(){
    ...
    $('#invoice_list').load(SITEURL+'/index.php?app=buy&feiwa=load_inv&vat_hash=<?php echo $output['vat_hash'];?>');
});
</script>