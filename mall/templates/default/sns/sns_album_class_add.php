...
<div class="eject_con">
  <div id="warning"></div>
  <form id="category_form" method="post" target="_parent" action="index.php?app=sns_album&feiwa=album_add_save">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt class="required"><em class="pngFix"></em><?php echo $lang['album_class_add_name'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input class="w300 text" type="text" name="name" id="name" value="" />
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['album_class_add_des'].$lang['feiwa_colon'];?></dt>
      <dd>
        <textarea class="w300" rows="3" name="description" id="description"></textarea>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['album_class_add_sort'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'index.php?app=sns_album&feiwa=ajax_check_class_name&column=ok',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
