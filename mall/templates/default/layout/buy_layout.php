...
<?php if ($_GET['app'] != 'buy_virtual') {?>
<script src="<?php echo MALL_RESOURCE_SITE_URL;?>/js/goods_cart.js"></script>
<?php } else { ?>
<script src="<?php echo MALL_RESOURCE_SITE_URL;?>/js/buy_virtual.js"></script>
<?php } ?>
...
<?php require_once template('layout/layout_top');?>  <header class="ncc-head-layout">
    ...
    <?php if ($_GET['feiwa'] != 'pd_pay' && $_POST['payment_code'] != 'wxpay') { ?>
    <ul class="ncc-flow">
