...
<div class="feiwa-ss-chain-detail">
  <div class="chain-img"><img src="<?php echo UPLOAD_SITE_URL.DS.chain.DS.$output['chain_info']['store_id'].DS.$output['chain_info']['chain_img'];?></div>
