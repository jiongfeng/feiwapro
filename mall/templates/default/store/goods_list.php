...
<div class="wrapper mt10">
  <div class="feiwa-ss-main-container">
    <div class="title">
      <h4><?php if(!empty($_GET['stc_id'])){echo $output['stc_name'];}elseif(!empty($_GET['inkeyword'])){echo $lang['show_store_index_include'].$_GET['inkeyword'].$lang['show_store_index_goods'];}else{ echo $lang['feiwa_whole_goods']; }?> </h4>
    </div>
    <div class="feiwa-ss-goodslist-bar">
      <ul class="feiwa-ss-array">
    ...
    <div class="content feiwa-ss-all-goods-list mb15">
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-info"><span class="price"><?php echo $lang['currency'];?>
              ...
              </span><span class="goods-sold"><?php echo $lang['feiwa_sell_out'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['feiwa_jian'];?></span></dd>
    ...
    <?php }else{?>
    <div class="content feiwa-ss-all-goods-list">
    <div class="nothing">
