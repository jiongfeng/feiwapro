...
<div class="eject_con">
  ...
  <form method="post" target="_parent" action="<?php echo urlMall('goods', 'arrival_notice_submit')?>" id="arrival_form">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="goods_id" value="<?php echo $_GET['goods_id']; ?>" />
    <input type="hidden" name="type" value="<?php echo $_GET['type']; ?>" />
    <dl>
      <dt><i class="required">*</i>手机号码<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        <input type="text" class="text" name="mobile" id="mobile" value="<?php echo $output['member_info']['member_mobile']; ?>" />
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i>邮箱号码<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
