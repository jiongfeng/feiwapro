...
<div class="goods-gallery add-step2"><a class='sample_demo' id="select_submit" href="index.php?app=store_album&feiwa=pic_list&item=goods" style="display:none;"><?php echo $lang['feiwa_submit'];?></a>
  <div class="nav"><span class="l"><?php echo $lang['store_goods_album_users'];?> >
    ...
    <select name="jumpMenu" id="jumpMenu" style="width:100px;">
      <option value="0" style="width:80px;"><?php echo $lang['feiwa_please_choose'];?></option>
...
$(function(){
    ...
    $('#jumpMenu').change(function(){
        $('[nctype="mea_img"]').load('index.php?app=store_album&feiwa=pic_list&item=mobile<?php if ($output['type'] == 'replace') {?>&type=replace<?php }?>&id=' + $(this).val());
    });
});
</script>