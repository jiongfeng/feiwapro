...
<div class="feiwast-form-default">
  <dl>
    <dt>选择打印项：</dt>
    <dd>
      <form id="design_form" action="<?php echo urlMall('store_waybill', 'waybill_design_save');?>" method="post">
        <input type="hidden" name="waybill_id" value="<?php echo $output['waybill_info']['waybill_id'];?>">
        <ul id="waybill_item_list" class="feiwast-form-checkbox-list">
  ...
  <div class="bottom"><label class="submit-border"><input id="submit"  type="submit" class="submit" value="<?php echo $lang['feiwa_submit'];?>"></label></div>
</div>
...
$(document).ready(function() {
    ...
    $('[nctype="btn_item_edit"]').on('click', function() {
        ...
        $('#dialog_item_edit').feiwa_show_dialog({title:'微调'});
    });
