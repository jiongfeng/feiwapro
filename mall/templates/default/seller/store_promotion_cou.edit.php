...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_promotion_cou&feiwa=cou_edit_save" method="post">
    <input type="hidden" name="cou_id" value="<?php echo $info['id']; ?>" />
    <dl>
      <dt><i class="required">*</i>活动名称<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>开始时间<?php echo $lang['feiwa_colon'];?></dt>
      <dd><?php echo date('Y-m-d H:i', $info['tstart']); ?></dd>
    </dl>
    <dl>
      <dt>结束时间<?php echo $lang['feiwa_colon'];?></dt>
...
if (empty($g)) continue; ?>
            <tr class="off-shelf" data-product-id="<?php echo $g['goods_id']; ?>">
              ...
              <td class="tl"><a href="<?php echo urlMall('goods', 'index', array('goods_id' => $g['goods_id'], )); ?>"> <?php echo $g['goods_name']; ?> </a></td>
...
<?php } ?>
        ...
        <a id="cou-sku-choose-btn" href="index.php?app=store_promotion_cou&feiwa=cou_sku&cou_id=<?php echo $info['id']; ?>" class="ncbtn ncbtn-aqua">选择活动商品</a>
...
<?php foreach ((array) $output['data']['levels'] as $k => $v) { ?>
        <div data-cou-level-item="<?php echo (string) $k; ?>" class="feiwast-cou-rule">
          <div class="rule-note">
