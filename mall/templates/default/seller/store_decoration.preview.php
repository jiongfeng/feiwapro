...
<script type="text/javascript" src="<?php echo MALL_RESOURCE_SITE_URL;?>/js/jquery.feiwa_slider.js" charset="utf-8"></script>
...
<script type="text/javascript">
    $(document).ready(function(){
        //幻灯片
        $('[nctype="store_decoration_slide"]').feiwa_slider();
    });
</script>
