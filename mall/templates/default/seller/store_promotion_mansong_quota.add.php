...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_promotion_mansong&feiwa=mansong_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['mansong_quota_add_quantity'].$lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['mansong_price_explain2'].$output['setting_config']['promotion_mansong_price'].$lang['feiwa_yuan'];?></p>
