  ...
  <div class="feiwast-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="feiwast-form-default">
        ...
        <form id="post_form" method="post" action="index.php?app=store_return&feiwa=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
          <input type="hidden" name="form_submit" value="ok" />
          <h3>商家处理意见</h3>
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_seller_confirm'].$lang['feiwa_colon'];?></dt>
            <dd>
              <div>
                <label class="mr20">
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['return_message'].$lang['feiwa_colon'];?></dt>
            <dd>
          ...
          <div class="bottom">
              <label class="submit-border">
                <a class="submit" id="confirm_button"><?php echo $lang['feiwa_ok'];?></a>
              </label>
              <label class="submit-border">
