...
<head>
<script>
var SITEURL = '<?php echo MALL_SITE_URL;?>'; var MALL_TEMPLATES_URL = '<?php echo MALL_TEMPLATES_URL?>';
</script>
...
<div class="eject_con">
  ...
  <form method="post" action="<?php echo urlMall('store_goods_online', 'edit_body_ajax');?>" onsubmit="ajaxpost('body_form', '', '', 'onerror')" id="body_form">
