...
<div class="feiwast-form-default">
  <form id="add_form" action="<?php echo urlMall('store_groupbuy', 'groupbuy_quota_add_save');?>" method="post">
    <dl>
      ...
      <dd>
        ...
        <p class="hint">购买单位为月(30天)，您可以在所购买的周期内发布团购活动</p>
        <p class="hint"><?php echo '每月(30天)您需要支付'.$output['setting_config']['groupbuy_price'].$lang['feiwa_yuan'];?> ; </p>
