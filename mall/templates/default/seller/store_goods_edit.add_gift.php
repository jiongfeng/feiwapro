...
<form method="post" id="goods_gift" action="<?php echo urlMall('store_goods_online', 'save_gift');?>">
  ...
  <div class="feiwast-form-goods-gift" data-gid="<?php echo $value['goods_id'];?>">
...
$(function(){
    ...
    $('div[nctype="gift_goods_list"]').on('click', 'a[nctype="a_choose_goods"]', function(){
        _owner_gid = $(this).parents('.feiwast-form-goods-gift:first').attr('data-gid');
