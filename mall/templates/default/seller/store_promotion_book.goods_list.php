...
<?php } else {?>
  <strong>套餐过期时间<?php echo $lang['feiwa_colon'];?></strong> <strong style=" color:#F00;"><?php echo date('Y-m-d H:i:s',$output['book_quota']['bkq_endtime']);?></strong>
<?php }?>
  <ul>
  ...
  <tbody nctype="choose_goods_list">
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a class="btn-grapefruit" href='javascript:void(0);' nctype="del_choosed" data-param="{gid:<?php echo $val['goods_id'];?>, type:<?php if ($val['is_book'] == 1) {?>'book'<?php } else if ($val['is_presell'] == 1) {?>'presell'<?php }?>}"><i class="icon-trash"></i><p><?php echo $lang['feiwa_del'];?></p></a></span></td>
    </tr>
    <?php } ?>
    <?php } ?>
  </tbody>
