...
<?php } else {?>
  <strong>套餐过期时间<?php echo $lang['feiwa_colon'];?></strong> <strong style=" color:#F00;"><?php echo date('Y-m-d H:i:s',$output['fcode_quota']['fcq_endtime']);?></strong>
<?php }?>
  <ul>
  ...
  <tbody nctype="choose_goods_list">
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle">
        <span><a class="btn-bittersweet" href='<?php echo urlMall('store_promotion_fcode', 'download_f_code_excel', array('gid' => $val['goods_id']));?>' title="下载F码"><i class="icon-download"></i><p>下载</p></a></span>
