...
<div class="feiwast-form-default">
    <form id="add_form" action="index.php?app=store_promotion_cou&feiwa=cou_add_save" method="post">
    <dl>
    ...
    <dl>
      ...
      <dt><i class="required">*</i>开始时间<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <p class="hint">
<?php if (!$output['isOwnMall'] && $output['current_cou_quota']['tstart'] > 1) { ?>
...
<?php } ?>
    ...
    <dl>
      ...
      <dt><i class="required">*</i>结束时间<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
