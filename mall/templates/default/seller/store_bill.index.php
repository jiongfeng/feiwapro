...
<form method="get" action="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="app" value="store_bill" />
...
<table class="feiwast-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td><a href="index.php?app=store_bill&feiwa=show_bill&ob_id=<?php echo $bill_info['ob_id'];?>"><?php echo $lang['feiwa_view'];?></a></td>
    </tr>
    <?php }?>
    <?php } else { ?>
    <tr>
