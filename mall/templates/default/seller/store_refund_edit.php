...
<div class="feiwast-flow-layout">
  <div class="feiwast-flow-container">
    ...
    <div class="feiwast-form-default">
      ...
      <dl>
        <dt><?php echo $lang['refund_buyer_message'].$lang['feiwa_colon'];?></dt>
        <dd> <?php echo $output['refund']['reason_info']; ?> </dd>
      </dl>
      <dl>
        <dt><?php echo $lang['refund_order_refund'].$lang['feiwa_colon'];?></dt>
      ...
      <form id="post_form" method="post" action="index.php?app=store_refund&feiwa=edit&refund_id=<?php echo $output['refund']['refund_id']; ?>">
        <input type="hidden" name="form_submit" value="ok" />
        <h3>商家处理意见</h3>
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_seller_confirm'].$lang['feiwa_colon'];?></dt>
          <dd>
            <label class="mr20">
        ...
        <dl>
          <dt><i class="required">*</i><?php echo $lang['refund_message'].$lang['feiwa_colon'];?></dt>
          <dd>
