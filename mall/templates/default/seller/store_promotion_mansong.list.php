...
<div class="alert alert-block mt10">
  <?php if(!empty($output['current_mansong_quota'])) { ?>
  <strong>套餐过期时间<?php echo $lang['feiwa_colon'];?></strong><strong style="color: #F00;"><?php echo date('Y-m-d H:i:s', $output['current_mansong_quota']['end_time']);?></strong>
  </li>
  <?php } else { ?>
...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="app" value="store_promotion_mansong" />
    <input type="hidden" name="feiwa" value="mansong_list" />
    <tr>
      <td>&nbsp;</td>
...
<table class="feiwast-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle"><span><a href="index.php?app=store_promotion_mansong&feiwa=mansong_detail&mansong_id=<?php echo $val['mansong_id'];?>" class="btn-bluejeans"><i class="icon-th-list"></i>
        <p><?php echo $lang['feiwa_detail'];?></p>
