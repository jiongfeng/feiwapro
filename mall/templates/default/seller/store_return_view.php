  ...
  <div class="feiwast-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="feiwast-form-default">
        ...
        <dl>
          <dt><?php echo $lang['return_buyer_message'].$lang['feiwa_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo $lang['return_order_return'].$lang['feiwa_colon'];?></dt>
        ...
        <h3>商家处理意见</h3>
        <dl>
          <dt><?php echo '处理状态'.$lang['feiwa_colon'];?></dt>
...
$(function(){
	$.getJSON('index.php?app=seller_center&feiwa=get_express&e_code=<?php echo $output['e_code'];?>&shipping_code=<?php echo $output['return']['invoice_no'];?>&t=<?php echo random(7);?>',function(data){
		if(data){
