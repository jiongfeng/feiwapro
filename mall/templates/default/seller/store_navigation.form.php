...
<div class="feiwast-form-default">
  <form method="post" action="index.php?app=store_navigation&feiwa=navigation_save" target="_parent" name="store_navigation_form" id="store_navigation_form" enctype="multipart/form-data">
    <input type="hidden" name="sn_id" value="<?php echo $output['sn_info']['sn_id'];?>"/>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['store_navigation_name'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input type="text" class="w150 text" name="sn_title" value="<?php echo $output['sn_info']['sn_title'];?>" /><span></span>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['store_navigation_display'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['store_goods_class_sort'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['store_navigation_content'].$lang['feiwa_colon'];?></dt>
      <dd>
        <?php showEditor('sn_content',$output['sn_info']['sn_content'],'600px','300px','','false',$output['editor_multimedia']); ?>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['store_navigation_url'].$lang['feiwa_colon']; ?></dt>
      <dd>
        <p>
    ...
    <dl>
      <dt><?php echo $lang['store_navigation_new_open'].$lang['feiwa_colon']; ?></dt>
      <dd>
        <ul class="feiwast-form-radio-list">
          <li>
