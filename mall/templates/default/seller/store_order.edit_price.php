...
<?php if ($output['order_info']) {?>
  ...
  <form id="changeform" method="post" action="index.php?app=store_order&feiwa=change_state&state_type=modify_price&order_id=<?php echo $output['order_info']['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo '运费'.$lang['feiwa_colon'];?></dt>
      <dd>
