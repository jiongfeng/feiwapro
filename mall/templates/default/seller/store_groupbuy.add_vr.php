...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_groupbuy&feiwa=groupbuy_save&vr=1" method="post" enctype="multipart/form-data">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['group_name'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt>团购副标题<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      ...
      <dd>
          ...
          <p class="hint"><?php echo '团购开始时间不能小于'.date('Y-m-d H:i', $output['groupbuy_start_time']);?></p>
      </dd>
    </dl>
    <dl>
...
<?php } ?>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['groupbuy_goods'].$lang['feiwa_colon'];?></dt>
      <dd>
      ...
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
          <table class="search-form">
              <tr>
                  ...
                  <td class="w70 tc">
                      <a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['feiwa_search'];?></a></td>
                    <td class="w10"></td>
                    <td>
    ...
    <dl nctype="groupbuy_goods_info" style="display:none;">
      <dt><?php echo $lang['groupbuy_index_store_price'].$lang['feiwa_colon'];?></dt>
      <dd> <?php echo $lang['currency'];?><span nctype="groupbuy_goods_price"></span></dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['groupbuy_price'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i>团购活动图片<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
      <div class="feiwast-upload-thumb groupbuy-pic">
    ...
    <dl>
      <dt>团购推荐位图片<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
      <div class="feiwast-upload-thumb groupbuy-commend-pic">
          <p><i class="icon-picture"></i>
          <img nctype="img_groupbuy_image" style="display:none;" src=""/></p>
      </div>
    ...
    <dl>
      <dt>团购分类<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <span></span>
        <p class="hint">请选择本次虚拟团购所属分类</p>
      </dd>
    </dl>
    <dl>
      <dt>团购区域<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <span></span>
        <p class="hint">请选择本次虚拟团购所属地区</p>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['virtual_quantity'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['sale_quantity'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input class="w70 text" id="upper_limit" name="upper_limit" type="text" value="0"/>
        <span></span>
        <p class="hint">每个买家ID可团购的最大数量，该数量不能大于虚拟商品本身的限购数量，不限数量请填"0"</p>
      </dd>
    </dl>
    <dl>
      <dt><?php echo $lang['group_intro'].$lang['feiwa_colon'];?></dt>
      <dd>
        <?php showEditor('groupbuy_intro','','740px','360px','','false',false);?>
        <p class="hr8"><a class="des_demo ncbtn" href="index.php?app=store_album&feiwa=pic_list&item=groupbuy"><i class="icon-picture"></i><?php echo $lang['store_goods_album_insert_users_photo'];?></a></p>
        <p id="des_demo" style="display:none;"></p>
      </dd>
    </dl>
    <div class="bottom"><label class="submit-border">
      <input type="submit" class="submit" value="<?php echo $lang['feiwa_submit'];?>"></label>
    </div>
  </form>
</div>
...
$("select[name=class]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?app=store_groupbuy&feiwa=ajax_vr_class&class_id='+class_id,
...
$("select[name=city]").change(function(){
    ...
    $.ajax({
        type:'GET',
        url:'index.php?app=store_groupbuy&feiwa=ajax_vr_area&area_id='+area_id,
        success:function(json){
            var html = '<option value="">'+'请选择...'+'</option>';
...
$("select[name=area]").change(function(){
    ...
    $('#btn_search_goods').on('click', function() {
        var url = "<?php echo urlMall('store_groupbuy', 'search_vr_goods'); ?>";
...
<?php } ?>
            ...
            upper_limit: {
                ...
                lessThanVrLimitNum : '虚拟团购活动的限购数量不能大于虚拟商品本身的限购数量'
            },
            groupbuy_image: {
