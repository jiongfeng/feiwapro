...
<div class="wrap">
  ...
  <div class="alert"> <strong><?php echo $lang['feiwa_explain'].$lang['feiwa_colon'];?></strong>
    <ul>
  ...
  <div class="feiwast-form-default"> 
    ...
    <form id="add_form" method="post" action="index.php?app=store_promotion_bundling&feiwa=bundling_add">
      <input type="hidden" name="form_submit" value="ok" />
      <?php if (!empty($output['bundling_info'])){?>
      <input type="hidden" name="bundling_id" value="<?php echo $output['bundling_info']['bl_id'];?>" />
      <?php }?>
      <dl>
        <dt><i class="required">*</i><?php echo $lang['bundling_name'].$lang['feiwa_colon'];?></dt>
        <dd>
          <p>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['bundling_add_price'].$lang['feiwa_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i><?php echo $lang['bundling_goods'].$lang['feiwa_colon'];?></dt>
        <dd>
          <p>
          ...
          <table class="feiwast-default-table mb15">
            <thead>
              <tr>
                ...
                <th class="w90"><?php echo $lang['feiwa_common_button_operate'];?></th>
              </tr>
            </thead>
          ...
          <a id="bundling_add_goods" href="index.php?app=store_promotion_bundling&feiwa=bundling_add_goods" class="ncbtn ncbtn-aqua"><?php echo $lang['bundling_goods_add'];?></a>
      ...
      <dl>
        <dt><?php echo $lang['bundling_add_freight_method'].$lang['feiwa_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><?php echo $lang['bundling_status'].$lang['feiwa_colon'];?></dt>
        <dd>
          <ul class="feiwast-form-radio-list">
