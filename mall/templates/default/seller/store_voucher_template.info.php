...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_title'].$lang['feiwa_colon']; ?></dt>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_enddate'].$lang['feiwa_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_end_date']?@date('Y-m-d',$output['t_info']['voucher_t_end_date']):'';?></dd>
</dl>
<dl>
  <dt><?php echo $lang['voucher_template_price'].$lang['feiwa_colon']; ?></dt>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_total'].$lang['feiwa_colon']; ?></dt>
...
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_eachlimit'].$lang['feiwa_colon']; ?></dt>
  <dd>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_orderpricelimit'].$lang['feiwa_colon']; ?></dt>
...
<?php } ?>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_describe'].$lang['feiwa_colon']; ?></dt>
  <dd>
    <textarea  name="txt_template_describe" rows="3" class="w300" readonly><?php echo $output['t_info']['voucher_t_desc'];?></textarea>
  </dd>
</dl>
<dl>
  <dt ><em class="pngFix"></em><?php echo $lang['voucher_template_image'].$lang['feiwa_colon']; ?></dt>
  <dd>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['feiwa_status'].$lang['feiwa_colon']; ?></dt>
  <dd>
...
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_giveoutnum'].$lang['feiwa_colon']; ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_giveout'];?>&nbsp;<?php echo $lang['voucher_template_eachlimit_unit'];?></dd>
</dl>
<dl>
  <dt><em class="pngFix"></em><?php echo $lang['voucher_template_usednum'].$lang['feiwa_colon']; ?></dt>
...
<dl>
  ...
  <dd>
    <input type="text" class="w340" onclick="oCopy(this)" value="<?php echo MALL_SITE_URL.DS;?>index.php?app=voucher&feiwa=getvoucher&tid=<?php echo $output['t_info']['voucher_t_id'];?>" readonly/>
<script>
	function oCopy(obj){
      obj.select();
...
<h3>已生成代金券
  <a id="voucher_exportbtn" class="ncbtn-mini" href="javascript:void(0);" onclick="javascript:go('index.php?app=store_voucher&feiwa=voucher_export&tid=<?php echo $output['t_info']['voucher_t_id']; ?>');" title="导出Excel" style="float: right; margin-right: 10px; display: none;">导出Excel</a>
</h3>
...
<script type="text/javascript">
  $("#voucher_list_div").load('index.php?app=store_voucher&feiwa=voucherlist&tid=<?php echo $output['t_info']['voucher_t_id']; ?>');
</script>
<?php } ?>
<div class="bottom">
  <a href="javascript:void(0);" class="submit" onclick="window.location='index.php?app=store_voucher&feiwa=templatelist'" > <?php echo $lang['voucher_template_backlist'];?></a>
</div>
<script type="text/javascript">
