...
<div class="feiwast-form-default">
  <div class="alert alert-block">
    <h4><?php echo $lang['feiwa_explain'].$lang['feiwa_colon'];?></h4>
    <ul>
  ...
  <form id="add_form" action="index.php?app=store_promotion_mansong&feiwa=mansong_save" method="post">
    <input id="level2_flag" type="hidden" value="false" />
    <input id="level3_flag" type="hidden" value="false" />
    <dl>
      <dt><i class="required">*</i><?php echo $lang['mansong_name'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['start_time'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['end_time'].$lang['feiwa_colon'];?></dt>
      <dd>
...
<?php } ?>
    ...
    <dl>
      <dt><i class="required">*</i>满即送规则<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        <input type="hidden" id="mansong_rule_count" name="rule_count">
        <ul id="mansong_rule_list" class="feiwast-mansong-rule-list">
        </ul>
        ...
        <div class="feiwast-mansong-error"><span id="mansong_price_error" style="display:none;"><i class="icon-exclamation-sign"></i>规则金额不能为空且必须为数字</span><span id="mansong_discount_error" style="display:none;"><i class="icon-exclamation-sign"></i>满减金额必须小于规则金额</span></div>
        <div class="feiwast-mansong-rule">
        ...
        <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
                    <table class="search-form">
                        <tr>
                            ...
                            <td class="w70 tc">
                                <a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['feiwa_search'];?></a>
                            </td>
                            <td class="w10"></td>
                            <td>
    ...
    <dl>
      <dt><?php echo $lang['text_remark'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <div class="bottom">
      <label class="submit-border"><input id="submit_button" type="submit" value="<?php echo $lang['feiwa_submit'];?>"  class="submit"></label>
    </div>
  </form>
</div>
