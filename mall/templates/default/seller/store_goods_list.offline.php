...
<form method="get" action="index.php">
  <table class="search-form">
    <input type="hidden" name="app" value="store_goods_offline" />
...
<table class="feiwast-default-table">
  <thead>
    ...
    <tr>
      ...
      <td colspan="10"><label for="all"><?php echo $lang['feiwa_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" feiwa_type="batchbutton" uri="<?php echo urlMall('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['feiwa_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['feiwa_del'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" feiwa_type="batchbutton" uri="<?php echo urlMall('store_goods_offline', 'goods_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['store_goods_index_show'];?></a>
    </tr>
    <?php } ?>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><a href="javascript:void(0)" onclick="ajax_get_confirm('','<?php echo urlMall('store_goods_offline', 'goods_show', array('commonid' => $val['goods_commonid']));?>')" class="ncbtn"><?php echo $lang['store_goods_index_show'];?></a></td>
    ...
    <tr style="display:none;"><td colspan="20"><div class="feiwast-goods-sku ps-container"></div></td></tr>
    <?php } ?>
    <?php } else { ?>
    <tr>
  ...
  <tfoot>
    <tr>
      ...
      <th colspan="10"><label for="all2"><?php echo $lang['feiwa_select_all'];?></label>
        <a href="javascript:void(0);" class="ncbtn-mini" feiwa_type="batchbutton" uri="<?php echo urlMall('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['feiwa_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['feiwa_del'];?></a> <a href="javascript:void(0);" class="ncbtn-mini" feiwa_type="batchbutton" uri="<?php echo urlMall('store_goods_offline', 'goods_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['store_goods_index_show'];?></a></th>
    </tr>
    <tr>
