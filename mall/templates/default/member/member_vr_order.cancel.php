<div class="eject_con">
  ...
  <form method="post" action="index.php?app=member_vr_order&feiwa=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id']; ?>" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form','','','onerror')">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><?php echo $lang['member_order_sn'].$lang['feiwa_colon'];?></dt>
      <dd><span class="num"><?php echo $output['order_info']['order_sn']; ?></span></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['member_change_cancel_reason'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <div class="bottom">
      <label class="submit-border"><input type="submit" id="confirm_button" class="submit" value="<?php echo $lang['feiwa_ok'];?>提交" /></label>
