...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="ncm-search-table">
      <input type="hidden" name='app' value='member_complain' />
      <tr>
        <td>&nbsp;</td>
  ...
  <table class="ncm-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        <td></td>
        <td class="w50"><div class="pic-thumb"><a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=> $goods['goods_id'])); ?>">
            <img src="<?php echo thumb($goods,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($goods,240); ?>>')" onMouseOut="toolTip()" /></a></div></td>
        <td class="tl"><dl class="goods-name">
            <dt><a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=> $goods['goods_id'])); ?>"><?php echo $goods['goods_name']; ?></a></dt>
        ...
        <td><?php
				...
				?></td>
        <td class="ncm-table-handle"><span><a href="index.php?app=member_complain&feiwa=complain_show&complain_id=<?php echo $val['complain_id'];?>" class="btn-bluejeans"><i class="icon-eye-open"></i>
          <p><?php echo $lang['complain_text_detail'];?></p></a></span>
            <?php if(intval($val['complain_state'])==10) { ?>
          <span><a href="javascript:void(0)" onclick="ajax_get_confirm('<?php echo $lang['complain_cancel_confirm'];?>','index.php?app=member_complain&feiwa=complain_cancel&complain_id=<?php echo $val['complain_id']; ?>')" class="btn-bittersweet"><i class="icon-ban-circle"></i>
