...
<div class="ncm-flow-layout">
  <div class="ncm-flow-container">
    ...
    <div class="alert alert-block alert-info">
     ...
     <ul><li><strong><?php echo $lang['member_show_receive_info'].$lang['feiwa_colon'];?></strong><?php echo $output['order_info']['extend_order_common']['reciver_name']?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['phone'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['order_info']['extend_order_common']['reciver_info']['address'];?></li>
      <li><strong><?php echo $lang['member_show_expre_my_fdback'].$lang['feiwa_colon'];?></strong><?php echo $output['order_info']['extend_order_common']['order_message']; ?></li>
      <li><strong><?php echo $lang['member_show_deliver_info'].$lang['feiwa_colon'];?></strong><?php echo $output['daddress_info']['seller_name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['telphone'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['area_info'];?>&nbsp;&nbsp;<?php echo $output['daddress_info']['address'];?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $output['daddress_info']['company'];?></li></ul>
    </div>
    <div class="tabmenu">
      <ul class="tab pngFix">
    ...
    <ul class="express-log" id="express_list">
      ...
      <li class="loading"><?php echo $lang['feiwa_common_loading'];?></li>
      <?php } ?>
    </ul>
  ...
  <div class="ncm-flow-item">
    ...
    <div class="item-goods">
      ...
      <dl>
        <dt>
          <div class="ncm-goods-thumb-mini"><a href="index.php?app=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><img src="<?php echo thumb($val,'60'); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
        </dt>
        <dd><a href="index.php?app=goods&goods_id=<?php echo $val['goods_id']; ?>" target="_blank"><?php echo $val['goods_name']; ?></a> <span class="rmb-price"><?php echo ncPriceFormat($val['goods_price']); ?>&nbsp;*&nbsp;<?php echo $val['goods_num']; ?>
    ...
    <div class="item-order">
        ...
        <dd><a href="javascript:void(0);"><?php echo $output['order_info']['order_sn']; ?></a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
          <div class="more"> <span class="arrow"></span>
            <ul>
              ...
              <li><?php echo $lang['member_show_order_pay_time'].$lang['feiwa_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_info']['payment_time']); ?></span></li>
              <?php } ?>
              <?php if($output['order_info']['extend_order_common']['shipping_time']) { ?>
      ...
      <dl>
        <dt><?php echo $lang['member_show_express_ship_code'].$lang['feiwa_colon'];?></dt>
      ...
      <dl class="line">
        ...
        <dd><?php echo $output['store_info']['store_name'];?><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
          <div class="more"><span class="arrow"></span>
            <ul>
              <li><?php echo $lang['member_address_location'].$lang['feiwa_colon'];?><span><?php echo $output['store_info']['area_info'].'&nbsp;'.$output['store_info']['store_address'];?></span></li>
...
$(function(){
	...
	$.getJSON('index.php?app=member_order&feiwa=get_express&e_code=<?php echo $output['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
		if(data){
