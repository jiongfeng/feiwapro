...
<div class="ncm-flow-layout" id="ncmComplainFlow">
  <div class="ncm-flow-container">
    ...
    <div class="ncm-default-form">
        ...
        <dl>
          <dt><?php echo $lang['complain_accused'].$lang['feiwa_colon'];?></dt>
          ...
          <dd>
            ...
            <?php echo $lang['complain_pic_none'];?>
                <?php if((intval($output['complain_info']['complain_state']) < 99)) { ?>
                    ...
                    <form style="display: none;" id="post_add_pic_form" method="post" action="index.php?app=member_complain&feiwa=complain_add_pic&complain_id=<?php echo $output['complain_info']['complain_id']; ?>" enctype="multipart/form-data">
        ...
        <?php if ($output['complain_info']['appeal_datetime'] > 0) { ?>
            ...
            <dl>
              <dt><?php echo $lang['complain_appeal_datetime'].$lang['feiwa_colon'];?></dt>
              ...
              <dt><?php echo $lang['complain_appeal_evidence'].$lang['feiwa_colon'];?></dt>
              <dd>
        ...
        <dl>
          <dt><?php echo '处理意见'.$lang['feiwa_colon'];?></dt>
          <dd><?php echo $output['complain_info']['final_handle_message'];?></dd>
          <dt><?php echo $lang['final_handle_datetime'].$lang['feiwa_colon'];?></dt>
