...
<div class="eject_con">
  <div id="warning"></div>
  <form action="index.php?app=cut&feiwa=pic_cut" id="form_cut" method="post">
    ...
    <div class="pic-cut-100">
      ...
      <div class="cut-btn">
        <input class="submit"  type="button" id="pic_submit" value="<?php echo $lang['feiwa_submit'];?>">
      </div>
    </div>
  </form>
</div>
...
$(function(){
    ...
    $('#pic_submit').click(function(){
		...
		$.post('index.php?app=cut&feiwa=pic_cut',d,function(data){
			call_back(data);
