      ...
      <form id="login_form" action="<?php echo urlLogin('login')?>" method="post">
        ...
        <dl>
          ...
          <dd>
            ...
            <a href="JavaScript:void(0);" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&feiwa=makecode&nchash=<?php echo getNchash();?>&t=' + Math.random();" class="change" title="<?php echo $lang['login_index_change_checkcode'];?>">
            <img src="index.php?app=seccode&feiwa=makecode&nchash=<?php echo getNchash();?>" class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
            <label></label>
          </dd>
        </dl>
        <?php } ?>
        <dl>
          <dt></dt>
          <dd>
            <input type="hidden" value="<?php echo MALL_SITE_URL?>/index.php?app=show_joinin" name="ref_url">
...
<div class="suspension-box">
  <div class="joinin-index-step suspension-step">
    ...
    <div class="item-l2">
      <a href="<?php echo urlMall('store_joinin', 'step0');?>" class="login">
      立即入驻<i></i></a>
    </div>
  </div>
</div>  
