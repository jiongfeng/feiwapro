...
<div id="apply_company_info" class="apply-company-info">
  ...
  <form id="form_company_info" action="index.php?app=store_joinin&feiwa=step2" method="post">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><input id="business_licence_start" name="business_licence_start" type="text" class="w90" />
            ...
            <span></span><br>三证合一版有效期为空时，请选20年。</td>
        </tr>
        <tr>
          <th><i>*</i>法定经营范围：</th>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">组织机构代码证<em>注：营业执照为三证合一无需填写，多证版必须上传。</em></th>
        </tr>
      </thead>
      <tbody>
        <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="all">
      <thead>
        <tr>
          <th colspan="20">一般纳税人证明<em>注：营业执照为三证合一无需填写，多证版必须上传。所属企业具有一般纳税人证明时，必填。</em></th>
        </tr>
      </thead>
      <tbody>
        <tr>
...
$(document).ready(function(){
    ...
    $('input[name="<?php echo $input_id;?>"]').fileupload({
        dataType: 'json',
        url: '<?php echo urlMall('store_joinin', 'ajax_upload_image');?>',
        formData: '',
        add: function (e,data) {
            data.submit();
        },
