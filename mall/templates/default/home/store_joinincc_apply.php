  ...
  <div class="sidebar">
        ...
        <dd style="display:none;">
          <ul>
            ...
            <li> <i></i>
              ...
              <a href="<?php echo urlMall('show_help', 'index', array('t_id' => $v['type_id'],'help_id' => $v['help_id']));?>" target="_blank"><?php echo $v['help_title'];?></a>
              <?php }else { ?>
    ...
    <div class="content">
      <ul>
			...
			?>
        <li><?php echo '电话'.($key+1).$lang['feiwa_colon'];?><?php echo $val;?></li>
        <?php
				}
			}
			 ?>
        <li><?php echo '邮箱'.$lang['feiwa_colon'];?><?php echo C('site_email');?></li>
      </ul> 
    </div>
  </div>
...
<!-- 协议 -->
<?php require('store_joinincc_apply.'.$output['sub_step'].'.php'); ?>
   </div>
  </div>
</div>