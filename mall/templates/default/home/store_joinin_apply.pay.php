...
<link rel="stylesheet" type="text/css" href="<?php echo RESOURCE_SITE_URL;?>/js/jquery-ui/themes/ui-lightness/jquery.ui.css"  />
  ...
  <div class="joinin-pay">
    ...
    <form id="form_paying_money_certificate" action="index.php?app=store_joinin&feiwa=pay_save" method="post" enctype="multipart/form-data">
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        <thead>
          <tr>
            <th colspan="2">银行汇款信息(企业)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th>银行开户名：</th>
            <td><?php echo $output['list_setting']['qyname']; ?></td>
          </tr>
          <tr>
            <th>银行账号：</th>
            <td><?php echo $output['list_setting']['qynumber']; ?></td>
          </tr>
          <tr>
            <th>开户银行支行名称：</th>
            <td><?php echo $output['list_setting']['qybankname']; ?></td>
          </tr>
          <tr>
            <th>支行联行号：</th>
            <td><?php echo $output['list_setting']['qylianhanghao']; ?></td>
          </tr>
        </tbody>
      </table>
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        <thead>
          <tr>
            <th colspan="2">银行汇款信息(个人)</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th>银行开户名：</th>
            <td><?php echo $output['list_setting']['grname']; ?></td>
          </tr>
          <tr>
            <th>银行账号：</th>
            <td><?php echo $output['list_setting']['grnumber']; ?></td>
          </tr>
          <tr>
            <th>开户银行支行名称：</th>
            <td><?php echo $output['list_setting']['grbankname']; ?></td>
          </tr>
          <tr>
            <th>支行联行号：</th>
            <td><?php echo $output['list_setting']['grlianhanghao']; ?></td>
          </tr>
        </tbody>
      </table>
      ...
      <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
        <tbody>
          ...
          <tr>
            <th>下载合同：</th>
            <td><a href="<?php echo $output['list_setting']['hetong']; ?>"><span style="color:red;">点击下载合同</span></a></td>
          </tr>
          <tr>
            <th>上传合同：</th>
            <td>
              <p><input name="hetong1" type="file" /><span></span></p>
              <p><input name="hetong2" type="file" /><span></span></p>
              <p><input name="hetong3" type="file" /><span></span></p>
              <p><input name="hetong4" type="file" /><span></span></p>
              <p><input name="hetong5" type="file" /><span></span></p>
              <p><input name="hetong6" type="file" /><span></span></p>
            </td>
          </tr>
          <tr>
            <th>其他证明文件：</th>
            <td>
              请发送到邮箱：<span style="color:red;"><?php echo $output['list_setting']['join_email']; ?></span>
            </td>
          </tr>
        </tbody>
      </table>
