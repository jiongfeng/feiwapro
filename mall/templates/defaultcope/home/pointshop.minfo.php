...
<div class="ncp-member-grade">
  ...
  <?php } ?>
  <div class="links">
    <div class="links"> <a href="<?php echo urlMall('pointgrade','index');?>" target="_blank">我的成长进度</a> <a href="<?php echo urlMall('pointgrade','exppointlog');?>" target="_blank">经验值明细</a> </div>
  </div>
</div>
<div class="ncp-member-point">
  <dl style="border-left: none 0;">
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_points" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_voucher&feiwa=index" target="_blank">
  ...
  <dl>
    <a href="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_pointorder&feiwa=orderlist" target="_blank">
...
<?php if (C('pointprod_isuse')==1){?>
<div class="ncp-memeber-pointcart"> <a href="index.php?app=pointcart" class="btn">礼品兑换购物车<?php if ($output['pointcart_count'] > 0){?><em><?php echo $output['pointcart_count']; ?></em><?php } ?></a></div>
<?php }?>
