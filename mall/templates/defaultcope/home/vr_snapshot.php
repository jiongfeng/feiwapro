...
<link href="<?php echo MALL_TEMPLATES_URL;?>/css/snapshot.css" rel="stylesheet" type="text/css">
...
<div class="wrapper">
  ...
  <div class="feiwa-s-main<?php if ($output['store_info']['is_own_mall']) echo ' ownmall'; ?>">
    ...
    <div class="feiwa-item-mn">
      ...
      <div class="snap">
        ...
        <p><a href="<?php echo urlMall('goods', 'index', array('goods_id' => $output['goods']['goods_id']));?>" target="_blank">点此查看最新商品详情</a></p>
      </div>
      <?php if($output['goods']["contractlist"]){?>
      <dl class="feiwa-ss-cti">
        <dt>服务承诺：</dt>
        <dd>
    ...
    <div class="feiwa-ss-info">
      ...
      <div class="content">
        ...
        <div class="btns"><a href="<?php echo urlMall('show_store', 'index', array('store_id' => $output['store_info']['store_id']), $output['store_info']['store_domain']);?>" class="goto" >进店逛逛</a><a href="javascript:collect_store('<?php echo $output['store_info']['store_id'];?>','count','store_collect')" >收藏店铺<span>(<em nctype="store_collect"><?php echo $output['store_info']['store_collect']?></em>)</span></a></div>
        <dl class="no-border">
          <dt>公司名称：</dt>
  ...
  <div id="content" class="feiwa-ss-goods-layout" >
    <div class="title"><span>订单详情</span></div>
    <div class="feiwa-ss-intro" id="ncGoodsIntro">
        ...
        <ul class="nc-goods-sort">
          ...
          <?php
            foreach ($output['goods']['goods_attr'] as $k => $v) {
                if ($v != '') {
                    echo '<li>'.$k.$lang['feiwa_colon'].$v.'</li>';
                }
            }
            }?>
        </ul>
