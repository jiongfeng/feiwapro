  ...
  <div class="ncp-detail">
    ...
    <div class="ncp-gift-summary">
      ...
      <div class="ncp-meta">
        ...
        <dl>
          <dt><?php echo $lang['pointprod_info_goods_limittime'].$lang['feiwa_colon']; ?></dt>
          <dd>
      ...
      <div class="ncp-key">
        <dl>
          <dt><?php echo $lang['pointprod_info_goods_exchangenum'].$lang['feiwa_colon']; ?></dt>
          <dd class="ncp-figure-input">
            <input name="exnum" type="text" class="text w30" id="exnum" value='1' size="4"/>
            <span>（<?php echo $lang['pointprod_info_goods_lastnum'].$lang['feiwa_colon']; ?><?php echo $output['prodinfo']['pgoods_storage']; ?>
    ...
    <div style=" position: absolute; z-index: 1; top: -1px; right: -1px;">
      <div class="ncp-info">
        ...
        <div class="content">
          <dl>
            <dt><?php echo $lang['pointprod_info_goods_serial'].$lang['feiwa_colon']; ?></dt>
      ...
      <div class="ncp-sidebar-container">
        ...
        <div class="content">
          ...
          <ul class="recommend">
            ...
            <li>
              <div class="gift-pic"><a target="_blank" href="<?php echo urlMall('pointprod', 'pinfo', array('id' => $v['pgoods_id']));?>" title="<?php echo $v['pgoods_name']; ?>"> <img src="<?php echo $v['pgoods_image'] ?>" alt="<?php echo $v['pgoods_name']; ?>" /> </a></div>
...
function add_to_cart()
{
	...
	if(checkresult == false){
		...
		$.getJSON('<?php echo MALL_SITE_URL; ?>/index.php?app=pointcart&feiwa=add&pgid=<?php echo $output['prodinfo']['pgoods_id']; ?>&quantity='+quantity, function(result){
	        if(result.done){
	        	window.location.href = '<?php echo MALL_SITE_URL; ?>/index.php?app=pointcart';
	        } else {
		        if(result.url){
