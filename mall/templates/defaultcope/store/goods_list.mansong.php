      ...
      <ul>
        ...
        <li>
          <dl>
            ...
            <dd class="goods-info"><span class="price"><?php echo $lang['currency'];?> <?php echo ncPriceFormat($value['goods_promotion_price']);?> </span><span class="goods-sold"><?php echo $lang['feiwa_sell_out'];?><strong><?php echo $value['goods_salenum'];?></strong> <?php echo $lang['feiwa_jian'];?></span></dd>
