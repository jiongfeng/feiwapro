...
$(function(){
	...
	var search_app = $("#details").find("li[class='current']").attr("app");
	$('#search_app').attr("value",search_app);
	$("#keyword").blur();
});
</script>
</head>
