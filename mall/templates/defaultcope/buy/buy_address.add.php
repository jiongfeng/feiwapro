...
<div class="ncc-form-default">
  <form method="POST" id="addr_form" action="index.php">
    ...
    <input type="hidden" value="add_addr" name="feiwa">
    <input type="hidden" name="form_submit" value="ok"/>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_input_true_name'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input type="text" class="text w100" name="true_name" maxlength="20" id="true_name" value=""/>
      </dd>
    </dl>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_area'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><i class="required">*</i><?php echo $lang['cart_step1_whole_address'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt> <i class="required">*</i><?php echo $lang['cart_step1_mobile_num'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input type="text" class="text w200" name="mob_phone" id="mob_phone" maxlength="15" value=""/>
        &nbsp;&nbsp;(或)&nbsp;<?php echo $lang['cart_step1_phone_num'].$lang['feiwa_colon'];?>
