...
<div class="dialog-share">
  <form method="post" action="index.php?app=member_snsindex&feiwa=sharestore&<?php if($_GET['irefresh'] == 1){?>irefresh=1<?php }?>" id="sharestore_form">
    ...
    <div class="share-content">
      ...
      <!-- 验证码 -->
      <div id="ss_seccode" class="seccode"><?php echo $lang['feiwa_checkcode'].$lang['feiwa_colon']; ?>
    ...
    <!-- 防止点击Enter键提交 -->
    <div class="bottom">
      <input name="<?php echo $lang['feiwa_snsshare'];?>" type="button" class="button" value="<?php echo $lang['feiwa_snsshare'];?>" id="weibobtn_store" />
	...
	$("#weibobtn_store").click(function(){
		if($("#sharestore_form").valid()){
			...
			if(cookienum >= max_recordnum && $("#ss_seccode").css('display') == 'none'){
				...
				$("#ss_seccode").find("[name='codeimage']").attr('src','index.php?app=seccode&feiwa=makecode&nchash='+nchash+'&t=' + Math.random());
