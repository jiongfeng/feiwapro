...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <input type="hidden" name="app" value="member_refund" />
  ...
  <table class="ncm-default-table order">
    ...
    <tbody>
      ...
      <tr>
        <th colspan="20"> <span class="ml10"><?php echo $lang['refund_order_refundsn'].$lang['feiwa_colon'];?><?php echo $val['refund_sn']; ?></span><span><?php echo $lang['refund_buyer_add_time'].$lang['feiwa_colon'];?><?php echo date("Y-m-d H:i:s",$val['add_time']);?></span>

          <!-- store_name -->
          <span> <a href="<?php echo urlMall('show_store','index',array('store_id'=> $val['store_id']), $output['store_list'][$val['store_id']]['store_domain']);?>" target="_blank" title="<?php echo $order_info['store_name'];?>"><?php echo $val['store_name']; ?></a></span>
      ...
      <tr class="bd-line" >
        ...
        <td class="w50"><div class="pic-thumb"><a href="<?php echo urlMall('goods','index',array('goods_id'=> $val['goods_id']));?>" target="_blank"><img src="<?php echo thumb($val,60);?>"  onMouseOver="toolTip('<img src=<?php echo thumb($val,240);?>>')" onMouseOut="toolTip()"/></a></div></td>
        ...
        <td class="bdr"><a href="index.php?app=member_refund&feiwa=view&refund_id=<?php echo $val['refund_id']; ?>" class="ncbtn"><?php echo $lang['feiwa_view'];?> </a></td>
      </tr>
      <?php } ?>
    </tbody>
    <tfoot>
