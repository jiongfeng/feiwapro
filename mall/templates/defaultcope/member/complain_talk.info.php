...
<h3><?php echo $lang['talk_detail'];?></h3>
  <dl>
    <dt><?php echo $lang['talk_list'].$lang['feiwa_colon'];?></dt>
    <dd>
  ...
  <dl>
    <dt><?php echo $lang['talk_send'].$lang['feiwa_colon'];?></dt>
    <dd>
  ...
  <form action="index.php?app=member_complain&feiwa=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?app=member_complain&feiwa=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?app=member_complain&feiwa=publish_complain_talk',
                cache:false,
