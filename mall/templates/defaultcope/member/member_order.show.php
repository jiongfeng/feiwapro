...
<div class="ncm-oredr-show">
  <div class="ncm-order-info">
    <div class="ncm-order-details">
      ...
      <div class="content">
        <dl>
          <dt><?php echo $lang['member_show_order_receiver'].$lang['feiwa_colon'];?></dt>
        ...
        <dl>
          <dt><?php echo $lang['member_show_order_buyer_message'].$lang['feiwa_colon'];?></dt>
          <dd><?php echo $output['order_info']['extend_order_common']['order_message']; ?></dd>
        </dl>
        <dl class="line">
          <dt><?php echo $lang['member_change_order_no'].$lang['feiwa_colon'];?></dt>
          <dd><?php echo $output['order_info']['order_sn']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                ...
                <li><?php echo $lang['member_order_pay_method'].$lang['feiwa_colon'];?><span><?php echo $output['order_info']['payment_name']; ?>
                  ...
                  (<?php echo '付款单号'.$lang['feiwa_colon'];?><?php echo $output['order_info']['pay_sn']; ?>)
                  <?php } ?>
                  </span> </li>
                <?php } ?>
                <li><?php echo $lang['member_order_time'].$lang['feiwa_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_info']['add_time']); ?></span></li>
                <?php if(intval($output['order_info']['payment_time'])) { ?>
                <li><?php echo $lang['member_show_order_pay_time'].$lang['feiwa_colon'];?><span>
                ...
                <li><?php echo $lang['member_show_order_send_time'].$lang['feiwa_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_info']['extend_order_common']['shipping_time']); ?></span></li>
                <?php } ?>
                <?php if(intval($output['order_info']['finnshed_time'])) { ?>
                <li><?php echo $lang['member_show_order_finish_time'].$lang['feiwa_colon'];?><span><?php echo date("Y-m-d H:i:s",$output['order_info']['finnshed_time']); ?></span></li>
                <?php } ?>
              </ul>
            </div>
            </a></dd>
        ...
        <dl>
          <dt><?php echo $lang['member_show_order_seller_info'].$lang['feiwa_colon'];?></dt>
          <dd><?php echo $output['order_info']['extend_store']['store_name']; ?><a href="javascript:void(0);">更多<i class="icon-angle-down"></i>
            <div class="more"><span class="arrow"></span>
              <ul>
                <li><?php echo $lang['member_address_location'].$lang['feiwa_colon'];?><span><?php echo $output['order_info']['extend_store']['area_info'].'&nbsp;'.$output['order_info']['extend_store']['store_address']; ?></span></li>
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>1. 您尚未对该订单进行支付，请<a href="index.php?app=buy&feiwa=pay&pay_sn=<?php echo $output['order_info']['pay_sn'];?>" class="ncbtn-mini ncbtn-bittersweet"><i></i>支付订单</a>以确保商家及时发货。</li>
    ...
    <div class="ncm-order-condition">
      ...
      <ul>
        ...
        <li>2. 将感兴趣的<a href="index.php?app=member_favorite_goods&feiwa=fglist" class="ncbtn-mini">收藏商品</a>加入购物车进行购买。</li>
        <li>3. 看一看<a href="<?php echo urlMall('show_store','index',array('store_id'=>$output['order_info']['store_id']), $output['order_info']['extend_store']['store_domain']);?>" class="ncbtn-mini">该店铺</a>中有什么新商品上架。</li>
      </ul>
    </div>
    <?php } else { ?>
    <div class="ncm-order-condition">
    ...
    <?php } ?>
    <?php } ?>
    <div class="mall-msg">有疑问可咨询<a href="javascript:void(0);" onclick="ajax_form('mall_consult', '平台客服', '<?php echo urlMall('member_mallconsult', 'add_mallconsult', array('inajax' => 1));?>', 640);"><i class="icon-comments-alt"></i>平台客服</a></div>
  </div>
  ...
  <div class="ncm-order-contnet">
    <table class="ncm-default-table order">
      ...
      <tbody>
        ...
        <tr>
          <th colspan="7" style="border-right: none;"> <div class="order-deliver"><span>物流公司： <a target="_blank" href="<?php echo $output['order_info']['express_info']['e_url'];?>"><?php echo $output['order_info']['express_info']['e_name'];?></a></span><span> <?php echo $lang['member_show_order_shipping_no'].$lang['feiwa_colon'];?> <?php echo $output['order_info']['shipping_code'];?> </span><span><a href="javascript:void(0);" id="show_shipping">物流跟踪<i class="icon-angle-down"></i>
              <div class="more"><span class="arrow"></span>
                <ul id="shipping_ul">
                  <li>加载中...</li>
                </ul>
        ...
        <tr class="bd-line">
          ...
          <td class="tl"><dl class="goods-name">
              <dt><a target="_blank" href="<?php echo $goods['goods_url']; ?>"><?php echo $goods['goods_name']; ?></a><span class="rec"><a target="_blank" href="<?php echo urlMall('snapshot', 'index', array('rec_id' => $goods['rec_id']));?>">[交易快照]</a></span></dt>
              ...
              <dd>退款单号：<a target="_blank" href="index.php?app=member_refund&feiwa=view&refund_id=<?php echo $output['refund_all']['refund_id'];?>"><?php echo $output['refund_all']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 1) {?>
              <dd>退款单号：<a target="_blank" href="index.php?app=member_refund&feiwa=view&refund_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php }else if($goods['extend_refund']['refund_type'] == 2) {?>
              <dd>退货单号：<a target="_blank" href="index.php?app=member_return&feiwa=view&return_id=<?php echo $goods['extend_refund']['refund_id'];?>"><?php echo $goods['extend_refund']['refund_sn'];?></a></dd>
              <?php } ?>
            </dl></td>
          <td></td>
          ...
          <td><!-- 退款 -->
            ...
            <p><a href="index.php?app=member_refund&feiwa=add_refund&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">退款/退货</a></p>
            <?php }?>
            
            <!-- 投诉 -->
            
            <?php if ($output['order_info']['if_complain']){ ?>
            <p><a href="index.php?app=member_complain&feiwa=complain_new&order_id=<?php echo $output['order_info']['order_id']; ?>&goods_id=<?php echo $goods['rec_id']; ?>">交易投诉</a></p>
            <?php } ?></td>
          ...
          <td rowspan="<?php echo $output['order_info']['goods_count'];?>"><?php if ($output['order_info']['if_lock']) { ?>
            ...
            <p><a href="javascript:void(0)" style="color:#F30; text-decoration:underline;" feiwa_type="dialog" dialog_width="480" dialog_title="<?php echo $lang['member_order_cancel_order'];?>" dialog_id="buyer_order_cancel_order" uri="index.php?app=member_order&feiwa=change_state&state_type=order_cancel&order_id=<?php echo $output['order_info']['order_id']; ?>"  id="order_action_cancel"><?php echo $lang['member_order_cancel_order'];?></a></p>
            <?php } ?>
            
            <!-- 退款取消订单 -->
            
            <?php if ($output['order_info']['if_refund_cancel']){ ?>
            <p><a href="index.php?app=member_refund&feiwa=add_refund_all&order_id=<?php echo $output['order_info']['order_id']; ?>" class="ncbtn">订单退款</a></p>
            <?php } ?>
            
            <!-- 收货 -->
            
            <?php if ($output['order_info']['if_receive']) { ?>
            <p><a href="javascript:void(0)" class="ncbtn" feiwa_type="dialog" dialog_id="buyer_order_confirm_order" dialog_width="480" dialog_title="<?php echo $lang['member_order_ensure_order'];?>" uri="index.php?app=member_order&feiwa=change_state&state_type=order_receive&order_sn=<?php echo $output['order_info']['order_sn']; ?>&order_id=<?php echo $output['order_info']['order_id']; ?>" id="order_action_confirm"><?php echo $lang['member_order_ensure_order'];?></a></p>
            <?php } ?>
            
            <!-- 评价 -->
            
            <?php if ($output['order_info']['if_evaluation']) { ?>
            <p><a class="ncbtn ncbtn-aqua" href="index.php?app=member_evaluate&feiwa=add&order_id=<?php echo $output['order_info']['order_id']; ?>"><?php echo $lang['member_order_want_evaluate'];?></a></p>
            <?php } ?>
            ...
            <p><a href="javascript:void(0)" feiwa_type="sharegoods" data-param='{"gid":"<?php echo $output['order_info']['extend_order_goods'][0]['goods_id'];?>"}'>分享商品</a></p>
            <?php } ?></td>
          <?php } ?>
          <!-- E 合并TD --> 
        </tr>
        ...
        <tr>
          <td colspan="20"><dl class="freight">
              <dd>
                ...
                <?php echo $lang['member_show_order_tp_fee'].$lang['feiwa_colon'];?><span><?php echo $lang['currency'];?><?php echo $output['order_info']['shipping_fee']; ?></span>
            ...
            <dl class="sum">
              <dt><?php echo $lang['member_order_sum'].$lang['feiwa_colon'];?></dt>
...
$(function(){
    $('#show_shipping').on('hover',function(){
    	...
    	$.getJSON('index.php?app=member_order&feiwa=get_express&e_code=<?php echo $output['order_info']['express_info']['e_code']?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
    		if(data){
