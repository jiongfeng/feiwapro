...
<div class="wrap">
  <div class="tabmenu">
    <ul id="listpj" class="tab">
      <li class="active"><a href="index.php?app=<?php echo $output['pj_act'];?>&feiwa=list">交易评价/晒单</a></li>
    </ul>
  </div>
  <form id="goodsevalform" method="get" class="tc">
    <input type="hidden" name="app" value="<?php echo $output['pj_act'];?>"/>
    ...
    <div class="ncm-evaluation-list">
      ...
      <div class="ncm-evaluation-timeline">
        ...
        <div class="goods-thumb"><a target="_blank" href="<?php echo urlMall('goods', 'index', array('goods_id' => $v['geval_goodsid']));?>"> <img src="<?php echo cthumb($v['geval_goodsimage'], 60);?>"> </a></div>
        <dl class="detail">
          <dt><a target="_blank" href="<?php echo urlMall('goods', 'index', array('goods_id'=>$v['geval_goodsid'])); ?>"><?php echo $v['geval_goodsname']?></a><span class="ml30">商品评分：<em class="raty" data-score="<?php echo $v['geval_scores'];?>"></em></span></dt>
