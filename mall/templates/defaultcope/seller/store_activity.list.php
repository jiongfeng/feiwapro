...
<table class="feiwast-default-table">
  ...
  <tbody>
    ...
    <tr>
      <td></td>
      <td class="tl"><a target="_blank" href="index.php?app=activity&activity_id=<?php echo $v['activity_id'];?>"><?php echo $v['activity_title']; ?></a></td>
      ...
      <td class="nscs-table-handle"><span><a id="a_<?php echo $v['activity_id'];?>" href="index.php?app=store_activity&feiwa=activity_apply&activity_id=<?php echo $v['activity_id'];?>"  class="btn-mint"><i class="icon-edit"></i>
