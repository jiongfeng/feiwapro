...
<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?app=store_album&feiwa=album_add_save">
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><i class="required">*</i><?php echo $lang['album_class_add_name'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    $('#category_form').validate({
        ...
        rules : {
        	name : {
                ...
                maxlength	: 20,
                remote   : {
                    url :'index.php?app=store_album&feiwa=ajax_check_class_name&column=ok',
                    type:'get',
                    data:{
                        ac_name : function(){
                            return $('#name').val();
