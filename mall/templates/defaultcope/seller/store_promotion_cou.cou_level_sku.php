  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?app=store_promotion_cou&feiwa=cou_level_sku&level=<?php echo $output['level']; ?>" nctype="search_a" class="feiwa-ss-btn"><i class="icon-search"></i><?php echo $lang['feiwa_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
...
?>
      <li nctype="<?php echo $val['goods_id'];?>">
        ...
        <dl class="goods-info">
          <dt><a href="<?php echo urlMall('goods', 'index', array('goods_id' => $val['goods_id'], )); ?>" target="_blank" title="<?php echo $lang['bundling_goods_name'].'/'.$lang['bundling_goods_code'];?><?php echo $val['goods_name'];?><?php  if($val['goods_serial'] != ''){ echo $val['goods_serial'];}?>"><?php echo $val['goods_name'];?></a></dt>
