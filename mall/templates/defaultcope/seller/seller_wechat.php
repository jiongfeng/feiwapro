...
<div class="feiwast-form-default">
	<form method="post" action="<?php echo urlMall('seller_wechat', 'index');?>">
...
<?php if (isset($output['wechat']['token'])) {?>
	<dl>
      <dt>接口URL：</dt>
	  <dd><?php echo MOBILE_SITE_URL;?>/index.php?app=weixin&token=<?php echo $output['wechat']['token'];?>&wx_store_id=<?php echo $output['account_id'];?></dd>
	</dl>
<?php }?>
	<dl>
