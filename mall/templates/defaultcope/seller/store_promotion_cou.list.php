...
<div class="alert alert-block mt10">
  <?php if(!empty($output['current_cou_quota'])) { ?>
  <strong>套餐过期时间<?php echo $lang['feiwa_colon'];?></strong><strong style="color:#F00;"><?php echo date('Y-m-d H:i:s', $output['current_cou_quota']['tend']);?></strong>
  <?php } else { ?>
...
<form method="get">
  <table class="search-form">
    <input type="hidden" name="app" value="store_promotion_cou" />
    <input type="hidden" name="feiwa" value="cou_list" />
    <tr>
      <td>&nbsp;</td>
      <th>状态</th>
  ...
  <tbody id="cou_list">
    <tr class="bd-line">
      ...
      <td class="nscs-table-handle tr">
          ...
          <span>
              <a href="index.php?app=store_promotion_cou&feiwa=cou_edit&cou_id=<?php echo $val['id'];?>" class="btn-bluejeans">
                  <i class="icon-edit"></i>
