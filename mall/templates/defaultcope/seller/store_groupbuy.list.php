...
<div class="alert alert-block mt10">
  <ul class="mt5">
    ...
    <li>2、如发布虚拟商品的团购活动，请点击新增虚拟团购按钮</li>
  </ul>
</div>
<?php } else { ?>
<div class="alert alert-block mt10">
  <?php if(!empty($output['current_groupbuy_quota'])) { ?>
  <strong>套餐过期时间<?php echo $lang['feiwa_colon'];?></strong><strong style="color: #F00;"><?php echo date('Y-m-d H:i:s', $output['current_groupbuy_quota']['end_time']);?></strong>
  <?php } else { ?>
  <strong>当前没有可用套餐，请先购买套餐</strong>
  <?php } ?>
  <ul class="mt5">
    <li>1、点击购买套餐和套餐续费按钮可以购买或续费套餐</li>
    <li>2、点击新增团购按钮可以添加团购活动</li>
    <li>3、如发布虚拟商品的团购活动，请点击新增虚拟团购按钮</li>
...
<table class="search-form">
  <form method="get">
    <input type="hidden" name="app" value="store_groupbuy" />
    <tr>
      <td>&nbsp;</td>
      <th>团购类型</th>
      <td class="w100">
        <select name="groupbuy_vr" class="w90">
          ...
          <option value="0"<?php if ($output['groupbuy_vr'] === '0') echo ' selected'; ?>>线上团</option>
