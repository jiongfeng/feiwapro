...
$(document).ready(function(){
	...
	$('#submit').on('click',function(){
		if ($('#address_form').valid()) {
            ...
            $.post(
            "<?php echo urlMall('store_deliver', 'buyer_address_save');?>", 
            {
