...
<form method="POST" id='express_form' action="index.php?app=store_deliver_set&feiwa=express" onsubmit="ajaxpost('express_form', '', '', 'onerror');return false;">
  ...
  <table class="feiwast-default-table" >
    ...
    <tfoot>
      <tr>
        <td colspan="20" class="bottom"><label class="submit-border"><input class="submit" type="submit" value="<?php echo $lang['feiwa_common_button_save'];?>"></label></td>
      </tr>
    </tfoot>
  </table>
</form>
