...
<div class="alert mt10"> <strong><?php echo $lang['feiwa_explain'].$lang['feiwa_colon'];?></strong> 只能查询“<?php echo $output['minDate']; ?>”到“<?php echo $output['maxDate']; ?>”的聊天记录，切换不同的选项卡选择可查看与店铺客服最近对话的会员。 </div>
<div class="tabmenu">
...
<div class="feiwast-chat-layout"><table class="search-form">
      <tr><td class="w10"></td>
...
<script>
    ...
    function select_seller(seller_id){
        ...
        var ajaxurl = 'index.php?app=store_im&feiwa=get_user_list&seller_id='+select_id;
    ...
    function store_chat_log(user_id){
        var ajaxurl = 'index.php?app=store_im&feiwa=get_chat_log&seller_id='+select_id;
