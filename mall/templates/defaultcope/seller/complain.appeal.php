...
<div class="feiwast-flow-layout" id="ncscComplainFlow">
  <div class="feiwast-flow-container">
    <div class="title">
      <h3>交易投诉申诉</h3>
    </div>
    <div class="feiwast-flow-step">
    ...
    <div class="feiwast-form-default">
      ...
      <dl>
        <dt><?php echo $lang['complain_state'].$lang['feiwa_colon'];?></dt>
        <dd><?php echo $output['complain_info']['complain_state_text'];?></dd>
        <dt><?php echo $lang['complain_subject_content'].$lang['feiwa_colon'];?></dt>
        <dd><?php echo $output['complain_info']['complain_subject_content'];?></dd>
        <dt><?php echo $lang['complain_evidence'].$lang['feiwa_colon'];?></dt>
        <dd>
          <?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = MALL_SITE_URL.'/index.php?app=show_pics&type=complain&pics=';
        ...
        <dt><?php echo $lang['complain_datetime'].$lang['feiwa_colon'];?></dt>
        <dd><?php echo date('Y-m-d H:i:s',$output['complain_info']['complain_datetime']);?></dd>
        <dt><?php echo $lang['complain_content'].$lang['feiwa_colon'];?></dt>
        <dd><?php echo $output['complain_info']['complain_content'];?></dd>
      </dl>
      <h3><?php echo $lang['complain_appeal_detail'];?></h3>
      <form action="index.php?app=store_complain&feiwa=appeal_save" method="post" id="add_form" enctype="multipart/form-data">
        <input name="input_complain_id" type="hidden" value="<?php echo $output['complain_info']['complain_id'];?>" />
        <dl>
          <dt><?php echo $lang['complain_appeal_content'].$lang['feiwa_colon'];?></dt>
          <dd>
            <textarea class="w600" name="input_appeal_message" rows="3"></textarea>
          </dd>
        </dl>
        <dl>
          <dt><?php echo $lang['complain_appeal_evidence_upload'].$lang['feiwa_colon'];?></dt>
          <dd>
            <p>
        ...
        <div class="bottom">
          <label class="submit-border">
            <input id="submit_button" type="submit" class="submit" value="<?php echo $lang['feiwa_submit'];?>">
          </label>
