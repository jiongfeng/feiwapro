<div class="goods-gallery add-step2"> <a class="sample_demo" id="select_s" href="index.php?app=store_album&feiwa=pic_list&item=des" style="display:none;"><?php echo $lang['feiwa_submit'];?></a>
