...
<div class="feiwast-form-default">
  ...
  <form id="add_form" action="<?php echo urlMall('store_promotion_sole', 'sole_quota_add');?>" method="post">
  <?php } else {?>
  <form id="add_form" action="<?php echo urlMall('store_promotion_sole', 'sole_renew');?>" method="post">
  <?php }?>
