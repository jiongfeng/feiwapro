...
<div class="wrap">
  ...
  <form method="post" id="form_snssetting" action="index.php?app=store_sns&feiwa=setting">
    ...
    <table class="feiwast-default-table">
      ...
      <tbody>
        <tr class="bd-line">
          ...
          <td><p><?php echo $lang['feiwa_store_auto_share_new1'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_new2'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_new3'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_new4'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_new5'];?></p></td>
        </tr>
        ...
        <tr class="bd-line">
          ...
          <td><p><?php echo $lang['feiwa_store_auto_share_xianshi1'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_xianshi2'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_xianshi3'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_xianshi4'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_xianshi5'];?></p></td>
        </tr>
        <tr class="bd-line">
          ...
          <td><p><?php echo $lang['feiwa_store_auto_share_mansong1'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_mansong2'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_mansong3'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_mansong4'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_mansong5'];?></p></td>
        </tr>
        <tr class="bd-line">
          ...
          <td><p><?php echo $lang['feiwa_store_auto_share_bundling1'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_bundling2'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_bundling3'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_bundling4'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_bundling5'];?></p></td>
        </tr>
        <tr class="bd-line">
          ...
          <td><p><?php echo $lang['feiwa_store_auto_share_groupbuy1'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_groupbuy2'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_groupbuy3'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_groupbuy4'];?></p>
            <p><?php echo $lang['feiwa_store_auto_share_groupbuy5'];?></p></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td colspan="20" class="bottom"><input type="submit" value="<?php echo $lang['feiwa_common_button_save'];?>" class="submit mt10 mb5" style="display: inline-block;"></td>
        </tr>
      </tfoot>
    </table>
  </form>
