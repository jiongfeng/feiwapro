...
<div class="feiwast-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'combo_quota_add') {echo urlMall('store_promotion_combo', 'combo_quota_add');} else {echo urlMall('store_promotion_combo', 'combo_renew');}?>" method="post">
