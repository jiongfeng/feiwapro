...
<div class="feiwast-form-default">
  ...
  <form id="add_form" action="index.php?app=store_promotion_bundling&feiwa=bundling_quota_add" method="post">
  <?php } else {?>
  <form id="add_form" action="index.php?app=store_promotion_bundling&feiwa=bundling_renew" method="post">
  <?php }?>
    <input type="hidden" name="form_submit" value="ok" />
    <dl>
      <dt><i class="required">*</i><?php echo $lang['bundling_quota_add_quantity'].$lang['feiwa_colon'];?></dt>
      <dd>
        <input id="bundling_quota_quantity" name="bundling_quota_quantity" type="text" class="text w50"/><em class="add-on"><?php echo $lang['feiwa_month'];?></em><span></span>
