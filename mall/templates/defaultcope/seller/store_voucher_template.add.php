<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_SITE_URL."/js/jquery-ui/themes/ui-lightness/jquery.ui.css";?>"/>
  ...
  <div class="tabmenu">
	...
	<div class="feiwast-form-default">
	  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=store_voucher&feiwa=<?php echo $output['type']=='add'?'templateadd':'templateedit'; ?>">
	  	<input type="hidden" id="app" name="app" value="store_voucher"/>
	  	<?php if ($output['type'] == 'add'){?>
	  	<input type="hidden" id="feiwa" name="feiwa" value="templateadd"/>
	  	<?php }else {?>
	  	<input type="hidden" id="feiwa" name="feiwa" value="templateedit"/>
	  	<input type="hidden" id="tid" name="tid" value="<?php echo $output['t_info']['voucher_t_id'];?>"/>
	  	<?php }?>
	  	<input type="hidden" id="form_submit" name="form_submit" value="ok"/>
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_title'].$lang['feiwa_colon']; ?></dt>
	      <dd>
...
<?php } ?>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_total'].$lang['feiwa_colon']; ?></dt>
	      <dd>
	    ...
	    <dl id="eachlimit_dl">
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_eachlimit'].$lang['feiwa_colon']; ?></dt>
	      <dd>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_orderpricelimit'].$lang['feiwa_colon']; ?></dt>
	      <dd>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_describe'].$lang['feiwa_colon']; ?></dt>
	      <dd>
	    ...
	    <dl>
	      <dt><i class="required">*</i><?php echo $lang['voucher_template_image'].$lang['feiwa_colon']; ?></dt>
	      <dd>
          <div id="customimg_preview" class="feiwast-upload-thumb voucher-pic"><p><?php if ($output['t_info']['voucher_t_customimg']){?>
          ...
          <input type="file" hidefocus="true" size="1" class="input-file" name="customimg" id="customimg" feiwa_type="customimg"/>
          </span>
	    ...
	    <div class="bottom">
	      ...
	      <a id='btn_add' class="submit" href="javascript:void(0);"><?php echo $lang['feiwa_submit'];?></a>
	      </label>
	      </div>
	  </form>
	</div>
