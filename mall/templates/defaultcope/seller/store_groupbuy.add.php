...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_groupbuy&feiwa=groupbuy_save" method="post" enctype="multipart/form-data">
    <dl>
...
<?php if (!$output['isOwnMall']) { ?>
          <?php echo '团购开始时间不能大于'.date('Y-m-d H:i', $output['current_groupbuy_quota']['end_time']);?>
          </p>
<?php } ?>
    ...
    <dl>
      ...
      <div id="div_search_goods" class="div-goods-select mt10" style="display: none;">
        ...
        <p class="hint"><?php echo $lang['groupbuy_goods_explain'];?></br><span class="red">团购生效后该商品的所有规格SKU都将执行统一的团购价格</span></p>
        </dd>
    </dl>
    ...
    <dl>
      <dt><?php echo $lang['groupbuy_class'].$lang['feiwa_colon'];?></dt>
      <dd>
