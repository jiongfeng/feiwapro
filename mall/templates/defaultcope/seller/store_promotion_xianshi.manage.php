...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_goods').on('click', function() {
            var url = "<?php echo urlMall('store_promotion_xianshi', 'goods_select');?>";
        ...
        $('#div_goods_search_result').on('click', '[nctype="btn_add_xianshi_goods"]', function() {
            ...
            $('#dialog_add_xianshi_goods').feiwa_show_dialog({width: 640, title: '限时折扣商品规则设定'});
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlMall('store_promotion_xianshi', 'xianshi_goods_add');?>', 
        ...
        $('#xianshi_goods_list').on('click', '[nctype="btn_edit_xianshi_goods"]', function() {
            ...
            $('#dialog_edit_xianshi_goods').feiwa_show_dialog({width: 450, title: '修改价格'});
        });
        ...
        $('#btn_edit_xianshi_goods_submit').on('click', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlMall('store_promotion_xianshi', 'xianshi_goods_price_edit');?>',
        ...
        $('#xianshi_goods_list').on('click', '[nctype="btn_del_xianshi_goods"]', function() {
            ...
            if(confirm('确认删除？')) {
                var xianshi_goods_id = $(this).attr('data-xianshi-goods-id');
                $.post('<?php echo urlMall('store_promotion_xianshi', 'xianshi_goods_delete');?>',
...
<table class="feiwast-default-table">
  <tbody>
    <tr>
      <td class="w90 tr"><strong><?php echo $lang['xianshi_name'].$lang['feiwa_colon'];?></strong></td>
      <td class="w120 tl"><?php echo $output['xianshi_info']['xianshi_name'];?></td>
      <td class="w90 tr"><strong><?php echo $lang['start_time'].$lang['feiwa_colon'];?></strong></td>
      <td class="w120 tl"><?php echo date('Y-m-d H:i',$output['xianshi_info']['start_time']);?></td>
      <td class="w90 tr"><strong><?php echo $lang['end_time'].$lang['feiwa_colon'];?></strong></td>
      <td class="w120 tl"><?php echo date('Y-m-d H:i',$output['xianshi_info']['end_time']);?></td>
      <td class="w90 tr"><strong><?php echo '购买下限'.$lang['feiwa_colon'];?></strong></td>
      <td class="w120 tl"><?php echo $output['xianshi_info']['lower_limit'];?></td>
      <td class="w90 tr"><strong><?php echo '状态'.$lang['feiwa_colon'];?></strong></td>
      <td class="w120 tl"><?php echo $output['xianshi_info']['xianshi_state_text'];?></td>
    </tr>
</table>
<div class="alert">
  <strong><?php echo $lang['feiwa_explain'];?><?php echo $lang['feiwa_colon'];?></strong>
  <ul>
...
<div id="div_goods_select" class="div-goods-select" style="display: none;">
    <table class="search-form">
      <tr><th class="w150"><strong>第一步：搜索店内商品</strong></th><td class="w160"><input id="search_goods_name" type="text w150" class="text" name="goods_name" value=""/></td>
        <td class="w70 tc"><a href="javascript:void(0);" id="btn_search_goods" class="ncbtn"/><i class="icon-search"></i><?php echo $lang['feiwa_search'];?></a></td><td class="w10"></td><td><p class="hint">不输入名称直接搜索将显示店内所有普通商品，特殊商品不能参加。</p></td>
      </tr>
    </table>
...
<table class="feiwast-default-table">
  ...
  <tbody id="xianshi_goods_list">
    ...
    <tr class="bd-line">
        ...
        <?php if($output['xianshi_info']['editable']) { ?>
        <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" data-goods-price="<?php echo $val['goods_price'];?>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['feiwa_edit'];?></p></a></span>
            <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<?php echo $val['xianshi_goods_id']?>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['feiwa_del'];?></p></a></span>
        <?php } ?>
        </td>
    </tr>
    <?php }?>
...
<div class="bottom">
  <label class="submit-border"><input type="submit" class="submit" id="submit_back" value="<?php echo $lang['feiwa_back'].$lang['xianshi_index'];?>" onclick="window.location='index.php?app=store_promotion_xianshi&feiwa=xianshi_list'"></label>
</div>
...
<tr class="bd-line">
    ...
    <td class="nscs-table-handle">
    <?php if($output['xianshi_info']['editable']) { ?>
    <span><a nctype="btn_edit_xianshi_goods" class="btn-bluejeans" data-xianshi-goods-id="<%=xianshi_goods_id%>" data-goods-price="<%=goods_price%>" href="javascript:void(0);"><i class="icon-edit"></i><p><?php echo $lang['feiwa_edit'];?></p></a></span>
        <span><a nctype="btn_del_xianshi_goods" class="btn-grapefruit" data-xianshi-goods-id="<%=xianshi_goods_id%>" href="javascript:void(0);"><i class="icon-trash"></i><p><?php echo $lang['feiwa_del'];?></p></a></span>
    <?php } ?>
    </td>
</tr>
</script> 
