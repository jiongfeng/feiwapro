...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_promotion_cou&feiwa=cou_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i>套餐购买数量<?php echo $lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <p class="hint">每月(30天)您需要支付<?php echo $output['setting_config']['promotion_cou_price'].$lang['feiwa_yuan'];?></p>
