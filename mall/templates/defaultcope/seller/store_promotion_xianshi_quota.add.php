...
<div class="feiwast-form-default">
  <form id="add_form" action="index.php?app=store_promotion_xianshi&feiwa=xianshi_quota_add_save" method="post">
    <dl>
      <dt><i class="required">*</i><?php echo $lang['xianshi_quota_add_quantity'].$lang['feiwa_colon'];?></dt>
      <dd>
        ...
        <p class="hint"><?php echo $lang['xianshi_price_explain2'].$output['setting_config']['promotion_xianshi_price'].$lang['feiwa_yuan'];?> ; </p>
...
$(document).ready(function(){
    ...
    $("#add_form").validate({
    	...
    	submitHandler:function(form){
            ...
            showDialog('<?php echo $lang['xianshi_quota_add_confirm'];?>'+price+'<?php echo $lang['feiwa_yuan'];?>', 'confirm', '', function(){
