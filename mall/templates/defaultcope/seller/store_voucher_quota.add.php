<?php defined('ByFeiWa') or exit('Access Invalid!'); ?>
  ...
  <div class="feiwast-form-default">
    <form id="add_form" action="index.php?app=store_voucher&feiwa=quotaadd" method="post">
    	<input type="hidden" name="form_submit" value="ok"/>
      <dl>
        <dt><i class="required">*</i><?php echo $lang['voucher_apply_addnum'].$lang['feiwa_colon'];?></dt>
        <dd><input id="quota_quantity" name="quota_quantity" type="text" class="text w50"/><em class="add-on"><?php echo $lang['feiwa_month'];?></em><span></span>
