...
<div class="feiwast-form-default">
  <form method="post" action="index.php?app=store_info&feiwa=bind_class_save" target="_parent" name="store_bind_class_form" id="store_bind_class_form">
    <input type="hidden" name="form_submit" value="ok" />
    <input id="goods_class" name="goods_class" type="hidden" value="">
    <dl>
      <dt>选择分类<?php echo $lang['feiwa_colon'];?></dt>
      <dd id="gcategory">
...
<label id="error_message" style="display: none" class="error" for="sn_title"><i class="icon-exclamation-sign"></i>请选择分类</label>
    ...
    <div class="bottom">
      <label class="submit-border"><input type="button" id="btn_add_bind_class" class="submit" value="<?php echo $lang['feiwa_submit'];?>" /></label>
    </div>
  </form>
</div>
