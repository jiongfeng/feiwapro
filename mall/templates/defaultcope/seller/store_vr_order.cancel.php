...
<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="index.php?app=store_vr_order&feiwa=change_state&state_type=order_cancel&order_id=<?php echo $output['order_id']; ?>">
    ...
    <dl>
      <dt><?php echo $lang['store_order_cancel_reason'].$lang['feiwa_colon'];?></dt>
      <dd>
        <ul class="checked">
          <li>
    ...
    <dl class="bottom">
      <dt>&nbsp;</dt>
      <dd>
        <input type="submit" class="submit" id="confirm_button" value="<?php echo $lang['feiwa_ok'];?>" />
      </dd>
    </dl>
  </form>
</div>
