  ...
  <table class="search-form">
    <tbody>
      <tr>
        ...
        <td class="tc w70"><a href="index.php?app=store_promotion_bundling&feiwa=bundling_add_goods" nctype="search_a" class="feiwa-ss-btn"><i class="icon-search"></i><?php echo $lang['feiwa_search'];?></a></td>
        <td class="w10"></td>
      </tr>
    </tbody>
  </table>
