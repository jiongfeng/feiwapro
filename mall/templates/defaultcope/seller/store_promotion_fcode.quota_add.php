...
<div class="feiwast-form-default">
  <form id="add_form" action="<?php if ($output['menu_key'] == 'fcode_quota_add') {echo urlMall('store_promotion_fcode', 'fcode_quota_add');} else {echo urlMall('store_promotion_fcode', 'fcode_renew');}?>" method="post">
