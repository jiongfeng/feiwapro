...
<div class="feiwast-vr-order-exchange">
    <dl>
      <dt><h3>电子兑换码</h3></dt>
      <dd>
...
$(document).ready(function(){
    ...
    Tpl += "<td>FEIWA_CODE</td>\n";
    Tpl += "<td class=\"w70\"><div class=\"feiwast-goods-thumb\"><a target=\"_blank\" href=\"FEIWA_GOODS_URL\"><img onmouseout=\"toolTip()\" onmouseover=\"toolTip('<img src=FEIWA_IMG240>')\" src=\"FEIWA_IMG60\"></a></div></td>\n";
    Tpl += "<td class=\"tl\"><a href=\"FEIWA_GOODS_URL\" target=\"_blank\">FEIWA_GOODS_NAME</a></td>\n";
    Tpl += "<td><a target=\"_blank\" href=\"FEIWA_ORDER_URL\">FEIWA_ORDER_SN</a></td>\n";
    Tpl += "<td class=\"bdr\">FEIWA_ORDER_MSG</td></tr>\n";
    function exPost() {
		$('#vr_code_waring').html('');
	    $.getJSON('index.php?app=store_vr_order&feiwa=exchange&form_submit=ok&vr_code='+$("#vr_code").val(),null, function(data){
	        ...
	        content = content.replace(/FEIWA_CODE/g,$("#vr_code").val());
	        content = content.replace(/FEIWA_GOODS_URL/g,data.data.goods_url);
	        content = content.replace(/FEIWA_IMG240/g,data.data.img_240);
	        content = content.replace(/FEIWA_IMG60/g,data.data.img_60);
	        content = content.replace(/FEIWA_GOODS_NAME/g,data.data.goods_name);
	        content = content.replace(/FEIWA_ORDER_URL/g,data.data.order_url);
	        content = content.replace(/FEIWA_ORDER_SN/g,data.data.order_sn);
	        content = content.replace(/FEIWA_ORDER_MSG/g,data.data.buyer_msg || '');
