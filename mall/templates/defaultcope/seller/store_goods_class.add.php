<div class="eject_con">
  ...
  <form id="category_form" method="post" target="_parent" action="index.php?app=store_goods_class&feiwa=goods_class_save">
    <?php if ($output['class_info']['stc_id']!=0) { ?>
    <input type="hidden" name="stc_id" value="<?php echo $output['class_info']['stc_id']; ?>" />
    <?php } ?>
    <dl>
      <dt><i class="required">*</i><?php echo $lang['store_goods_class_name'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <?php if ($output['class_info']['stc_id']==0) { ?>
    <dl>
      <dt><?php echo $lang['store_goods_class_sup_class'].$lang['feiwa_colon'];?></dt>
      <dd>
    ...
    <dl>
      <dt><?php echo $lang['store_goods_class_display_state'].$lang['feiwa_colon'];?></dt>
      <dd>
        <label>
