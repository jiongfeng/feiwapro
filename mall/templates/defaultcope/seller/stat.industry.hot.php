...
<form method="get" amtion="index.php" target="_self">
  <table class="search-form">
    <input type="hidden" name="app" value="statistics_industry" />
    <input type="hidden" name="feiwa" value="hot" />
    <tr>
    	<td class="tr">
    		<div class="fr">
...
<table class="feiwast-default-table">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="tl"><a href="<?php echo urlMall('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></td>
