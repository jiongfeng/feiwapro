...
class seller_orderControl extends mobileSellerControl {
    ...
    public function vr_order_listFeiWa() {
    ...
    public function order_infoFeiWa()
    {
     ...
     * 取消订单
     */
    public function order_cancelFeiWa() {
        $order_id = intval($_POST['order_id']);
        $reason = $_POST['reason'];
        $model_order = Model('order');
        $condition = array();
     ...
     * 修改运费
     */
    public function order_ship_priceFeiWa() {
        $order_id = intval($_POST['order_id']);
	   ...
	   * 修改商品价格
	   * */
    public function order_spay_priceFeiWa(){
        $model_order = Model('order');
     ...
     * 发货
     */
    public function order_deliver_sendFeiWa() {
        $order_id = intval($_POST['order_id']);
        $model_order = Model('order');
        $condition = array();
        $condition['order_id'] = $order_id;
