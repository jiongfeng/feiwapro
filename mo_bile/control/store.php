...
class storeControl extends mobileHomeControl
{
     ...
     * 店铺信息
     */
    public function store_infoFeiwa()
    {
        ...
        $store_info['is_distribution'] = $store_online_info['is_distribution'];
        // 店铺头像
        ...
        // 是否官方店铺
        $store_info['is_own_mall'] = (bool) $store_online_info['is_own_mall'];
     ...
     * 店铺商品分类
     */
    public function store_goods_classFeiwa()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
     ...
     * 店铺商品
     */
    public function store_goodsFeiwa()
    {
        $param = $_REQUEST;
    ...
    private function _goods_list_extend($goods_list) {
        ...
        foreach ($goods_list as $key => $value) {
            ...
            unset($goods_list[$key]['feiwa_distinct']);
        }
     ...
     * 商品评价
     */
    public function store_creditFeiwa() {
     ...
     * 店铺商品排行
     */
    public function store_goods_rankFeiwa()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_data(array());
     ...
     * 店铺商品上新
     */
    public function store_new_goodsFeiwa(){
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
     ...
     * 店铺简介
     */
    public function store_introFeiwa()
    {
        $store_id = (int) $_REQUEST['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
 ...
 */
  ...
  */
  ...
  public function store_class_listFeiwa(){
  	$condition = array();
     ...
     * 店铺促销活动
     */
    public function store_promotionFeiwa(){
        $param = $_REQUEST;
        $store_id = (int) $param['store_id'];
        if ($store_id <= 0) {
            output_error('参数错误');
