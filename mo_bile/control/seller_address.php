...
class seller_addressControl extends mobileSellerControl {
     ...
     * 地址列表
     */
    public function address_listFeiWa() {
...
//      output_data(array('address_list' => $address_list));
     ...
     * 地址详细信息
     */
    public function address_infoFeiWa() {
     ...
     * 删除地址
     */
    public function address_delFeiWa() {
//      $address_id = intval($_POST['address_id']);
//
//      $condition = array();
//      $condition['address_id'] = $address_id;
...
//		
     ...
     * 新增地址
     */
    public function address_addFeiWa() {
...
//      $lang   = Language::getLangContent();
 ...
 //保存 新增/编辑 表单
     ...
     * 编辑地址
     */
//  public function address_editFeiWa() {
//      $address_id = intval($_POST['address_id']);
//
//      //验证地址是否为本人
