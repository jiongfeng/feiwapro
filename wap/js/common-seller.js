...
function getSearchName() {
    ...
    if (e == "") {
        if (getCookie("deft_key_value") == null) {
            $.getJSON(ApiUrl + "/index.php?app=index&feiwa=search_hot_info",
            function(e) {
...
function getFreeVoucher(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=member_voucher&feiwa=voucher_freeex",
        data: {
            tid: e,
            key: t
        },
...
function updateCookieCart(e) {
    ...
    if (t) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=member_cart&feiwa=cart_batchadd",
            data: {
                key: e,
                cartlist: t
            },
...
function getCartCount(e, t) {
    ...
    if (getCookie("key") !== null && getCookie("cart_count") === null) {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=member_cart&feiwa=cart_count",
            data: {
                key: e
            },
            dataType: "json",
...
function getChatCount() {
    if ($("#header").find(".message").length > 0) {
        var e = getCookie("key");
        if (e !== null) {
            $.getJSON(ApiUrl + "/index.php?app=member_chat&feiwa=get_msg_count", {
                key: e
            },
            function(e) {
                if (e.datas > 0) {
    ...
    $.extend($, {
        ...
        areaSelected: function(options) {
            ...
            function _getAreaList() {
                $.ajax({
                    type: "get",
                    url: ApiUrl + "/index.php?app=area&feiwa=area_list",
                    data: {
                        area_id: ASID
                    },
                    dataType: "json",
        ...
        goodsClassSelected: function(options) {
            ...
            function _getGoodsClassList() {
                $.ajax({
                    type: "post",
                    url: ApiUrl + "/index.php?app=seller_goods_class&feiwa=class_list",
                    data: {
                        gc_id: ASID,
                        deep:ASDEEP,
                        client:'mobile',
...
function loadSeccode() {
    ...
    $.ajax({
        type: "get",
        url: ApiUrl + "/index.php?app=seccode&feiwa=makecodekey",
        async: false,
        dataType: "json",
        success: function(e) {
    ...
    $("#codeimage").attr("src", ApiUrl + "/index.php?app=seccode&feiwa=makecode&k=" + $("#codekey").val() + "&t=" + Math.random())
}
function favoriteStore(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=member_favorites_store&feiwa=favorites_add",
        data: {
            key: t,
            store_id: e
        },
...
function dropFavoriteStore(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=member_favorites_store&feiwa=favorites_del",
        data: {
            key: t,
            store_id: e
        },
...
function favoriteGoods(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=member_favorites&feiwa=favorites_add",
        data: {
            key: t,
            goods_id: e
        },
...
function dropFavoriteGoods(e) {
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=member_favorites&feiwa=favorites_del",
        data: {
            key: t,
            fav_id: e
        },
...
function getChatCount() {
    if ($('#header').find('.message').length > 0) {
        ...
        if (key !== null) {
            $.getJSON(ApiUrl+'/index.php?app=member_chat&feiwa=get_msg_count', {key:key}, function(result){
                if (result.datas > 0) {
                    $('#header').find('.message').parent().find('sup').show();
                    $('#header-nav').find('sup').show();
                }
