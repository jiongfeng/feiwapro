$(function() {
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_info",
                data: {
                    key: key,
    ...
    $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_image_info",
                data: {
                    key: key,
                    goods_commonid: commonid,
                },
    ...
    $('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?app=seller_album&feiwa=image_upload",
            data:{
                key:key,
                name:"file"
            },
    ...
    $(".btn").click(function() {
        if ($.sValid()) {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_edit",
                data: {
                    key: key,
                    commonid:commonid,
                    cate_id: cate_id,
