$(function() { 
    ...
    $.ajax({
        type: "post",
        url: ApiUrl + "/index.php?app=seller_store&feiwa=store_info",
        data: {
            key: a
        },
        dataType: "json",
...
$('input[name="file"]').ajaxUploadImage({
            url : ApiUrl + "/index.php?app=seller_store&feiwa=file_upload",
            data:{key:a},
    ...
    $(".btn").click(function() {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?app=seller_store&feiwa=store_edit",
                data: {
                    key: a,
                    store_qq: e,
                    store_ww: r,
