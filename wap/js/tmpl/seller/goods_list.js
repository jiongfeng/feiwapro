...
$(function() {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_list&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                keyword : r
            ...
            success: function(e) {
                ...
                function goods_delete(commonid){
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_drop",
                        data: {
                            key: key,
                            commonids:commonid,
                        },
                ...
                function goods_unshow(commonid){
                    $.ajax({
                        type: "post",
                        url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_unshow",
                        data: {
                            key: key,
                            commonids:commonid,
                        },
    ...
    function a(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=member_order&feiwa=order_cancel",
            data: {
                order_id: r,
                key: e
            },
    ...
    function i(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=member_order&feiwa=order_delete",
            data: {
                order_id: r,
                key: e
            },
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?app=member_order&feiwa=order_receive",
            data: {
                order_id: r,
                key: e
            },
