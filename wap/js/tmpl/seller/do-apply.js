;(function($){
    ...
    $(".submit").click(function(){
        if($.sValid()){
            ...
            $.ajax({
                url: ApiUrl + "/index.php?app=seller_apply&feiwa=do_apply",
                type: 'POST',
                dataType: 'json',
...
;(function($){
    ...
    $('input[name="paying_money_certificate"]').fileupload({
        dataType: 'json',
        url: ApiUrl + '/index.php?app=seller_apply&feiwa=ajax_upload_image',
    ...
    $('#btn_select_category').on('click', function() {
        $(".gc-wrap-pre").remove();
        $.ajax({
            url: ApiUrl + "/index.php?app=seller_apply&feiwa=get_goods_category",
            type: 'POST',
            dataType: 'json',
            data: {client: Client},
            success: function(result){
