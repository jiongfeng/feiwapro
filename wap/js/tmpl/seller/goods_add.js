;(function($){
    ...
    $(".submit").click(function(){
        if($.sValid()){
            ...
            $.ajax({
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=save_goods",
                type: 'POST',
                dataType: 'json',
...
;(function($){
    ...
    //动态加载
    $.ajax({
        url: ApiUrl + "/index.php?app=seller_goods&feiwa=goods_add",
        type: 'POST',
        dataType: 'json',
    ...
    $("#msform").delegate("#goodsClassStapleArea", 'change', function() {
        ...
        if (stapleId > 0) {
            $.ajax({
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=ajax_show_comm",
                type: 'POST',
                dataType: 'json',
    ...
    $("#msform").delegate(".gc-select", 'change', function() {
        ...
        if (gc_id > 0 && deep <= 3) {
            next_select.remove();
            $.ajax({
                url: ApiUrl + "/index.php?app=seller_goods&feiwa=ajax_goods_class",
                type: 'POST',
                dataType: 'json',
    ...
    $('#goods_image').fileupload({
        dataType: 'json',
        url: ApiUrl + '/index.php?app=seller_goods&feiwa=ajax_image_upload&upload_type=uploadedfile',
