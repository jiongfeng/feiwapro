 ...
 * @copyright 2006-2010 Foleeo  
 * @copyright 2010-2011 Amazon.com,   or its affiliates.
...
class RequestCore
{
	...
	public function send_multi_request($handles, $opt = null)
	{
		...
		do
		{
			...
			while (($status = curl_multi_exec($multi_handle, $adtive)) === CURLM_CALL_MULTI_PERFORM)
			{
		...
		while ($adtive || count($handles_post) < $added);
