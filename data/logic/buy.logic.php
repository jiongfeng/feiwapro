...
//                 if (in_array($store_id,$own_mall_ids)) {
...
//             }
            ...
            foreach ($goods_list as $goods_info) {
                ...
                if (!intval($goods_info['bl_id'])) {
                    ...
                    $invite = Model()->table('goods_class')->where("gc_id=".$goods_info['gc_id'])->find();
                    $order_goods[$i]['commis_rate'] = $invite['commis_rate'];
                    $order_goods[$i]['invite_rates'] = $goods_info['goods_price']*$invite['commis_rate']/100;
