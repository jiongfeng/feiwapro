  ...
  <div class="middle-layout">
    ...
    <div class="tabs-panel middle-goods-list <?php echo $i==1 ? '':'tabs-hide';?>">
      <ul>
        ...
        <li>
          <dl>
            <dt class="goods-name"><a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=> $v['goods_id'])); ?>" title="<?php echo $v['goods_name']; ?>"> <?php echo $v['goods_name']; ?></a></dt>
            <dd class="goods-thumb"> <a target="_blank" href="<?php echo urlMall('goods','index',array('goods_id'=> $v['goods_id'])); ?>"> <img src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" alt="<?php echo $v['goods_name']; ?>" /> </a></dd>
