...
class groupbuyModel extends Model{
    ...
    public function getGroupbuyExtendInfo($groupbuy_info) {
        $groupbuy_info['groupbuy_url'] = urlMall('show_groupbuy', 'groupbuy_detail', array('group_id' => $groupbuy_info['groupbuy_id']));
        $groupbuy_info['goods_url'] = urlMall('goods', 'index', array('goods_id' => $groupbuy_info['goods_id']));
