...
<div class="admincp-map ui-widget-content" nctype="map_nav" style="display:none;" id="draggable" >
  <div class="title ui-widget-header" >
    <h3><?php echo $lang['feiwa_admin_navigation'];?></h3>
    <h5><?php echo $lang['feiwa_admin_navigation_subhead'];?></h5>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=pic_upload&type=admin_avatar&form_submit=ok&uploadpath=<?php echo ATTACH_ADMIN_AVATAR;?>',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','<?php echo $lang['feiwa_cut'];?>','<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=pic_cut&type=admin_avatar&x=100&y=100&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
...
function call_back(picname){
    $.getJSON('index.php?app=index&feiwa=save_avatar&avatar=' + picname, function(data){
        if (data) {
...
<div class="admincp-header">
  ...
  <div class="admincp-header-r">
    ...
    <ul class="operate nc-row">
      ...
      <li><a class="homepage show-option" target="_blank" href="<?php echo MALL_SITE_URL;?>" title="新窗口打开商城首页">&nbsp;</a></li>
      <li><a class="login-out show-option" href="index.php?app=index&feiwa=logout" title="安全退出管理中心">&nbsp;</a></li>
    </ul>
  </div>
  <div class="clear"></div>
</div>
...
<script language="javascript" type="text/javascript" src="http://js.users.51.la/16686019.js"></script>
<noscript><a href="http://www.51.la/?16686019" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="http://img.users.51.la/16686019.asp" style="border:none" /></a></noscript>
</div>
</body>
</html>
