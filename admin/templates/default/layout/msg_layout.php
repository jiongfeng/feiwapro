...
<div class="msgpage">
  <div class="msgbox">
    ...
    <div class="scon"><?php echo $lang['feiwa_auto_redirect'];?></div>
    <div class="button">
      ...
      <a href="<?php echo $output['url'];?>" class="ncap-btn"><?php echo $lang['feiwa_back_to_pre_page'];?></a> 
      <script type="text/javascript"> window.setTimeout("javascript:location.href='<?php echo $output['url'];?>'", <?php echo $time;?>); </script>
      <?php }else { ?>
      <a href="javascript:history.back()" class="ncap-btn"><?php echo $lang['feiwa_back_to_pre_page'];?></a> 
      <script type="text/javascript"> window.setTimeout("javascript:history.back()", <?php echo $time;?>); </script>
      <?php } } ?>
    </div>
    <?php } ?>
    <div class="powerby"><?php echo $lang['feiwa_feiwa_message'];?></div>
  </div>
</div>
</body>
</html>