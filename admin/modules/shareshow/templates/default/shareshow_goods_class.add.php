...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=goods_class&feiwa=goodsclass_list" title="返回分类列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['feiwa_shareshow_goods_class'];?> - 新增/编辑随心看分类<?php if(isset($output['class_info']['class_name'])) echo $output['class_info']['class_name'];?></h3>
        <h5><?php echo $lang['feiwa_shareshow_goods_class_subhead'];?></h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?app=goods_class&feiwa=goodsclass_save">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_parent_id"><?php echo $lang['shareshow_parent_class'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row class_keyword">
        <dt class="tit">
          <label for="class_sort"><em>*</em><?php echo $lang['shareshow_class_keyword'];?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="class_sort"><em>*</em><?php echo $lang['feiwa_sort'];?></label>
        </dt>
        <dd class="opt">
