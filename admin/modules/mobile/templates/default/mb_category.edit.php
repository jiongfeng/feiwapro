...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=mb_category&feiwa=mb_category_list" title="返回分类图片列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['link_index_mb_category'];?> - <?php echo $lang['feiwa_edit'];?>“<?php echo $output['goods_class'][$output['link_array']['gc_id']]['gc_name'];?>”</h3>
  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt"><input class="input-txt" type="text" readonly="readonly" value="<?php echo $output['goods_class'][$output['link_array']['gc_id']]['gc_name'];?>">
          <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <span class="err"></span>
          <p class="notic">展示图片，建议大小72px*72px</p>
        </dd>
      </dl>
