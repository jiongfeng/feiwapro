...
<div class="page">
  ...
  <div class="ncap-search-bar">
    ...
    <input type="hidden" name="app" value="stat_store" />
    <input type="hidden" name="feiwa" value="hotrank" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?app=stat_store&feiwa=hotrank_list&type='+type+'&search_sclass='+search_sclass+'&t=<?php echo $output['searchtime'];?>');
}
</script>