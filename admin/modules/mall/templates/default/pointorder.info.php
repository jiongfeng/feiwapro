...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"> <a class="back" href="<?php echo urlAdminMall('pointprod', 'pointorder_list'); ?>" title="返回列表"> <i class="fa fa-arrow-circle-o-left"></i> </a>
      <div class="subject">
        <h3>积分兑换 - 兑换详情</h3>
    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        <div class="misc-info">
          ...
          <dl>
            <dt><?php echo $lang['admin_pointorder_ordersn'];?><?php echo $lang['feiwa_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_ordersn'];?></dd>
            <dt><?php echo $lang['admin_pointorder_orderstate'];?><?php echo $lang['feiwa_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_orderstatetext']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_addtime'];?><?php echo $lang['feiwa_colon'];?></dt>
        ...
        <div class="addr-note">
          <h4>购买/收货方信息</h4>
          <dl>
            <dt><?php echo $lang['admin_pointorder_membername'];?><?php echo $lang['feiwa_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_buyername'];?></dd>
            <dt><?php echo $lang['admin_pointorder_info_memberemail']; ?><?php echo $lang['feiwa_colon'];?></dt>
          ...
          <dl>
            <dt><?php echo $lang['admin_pointorder_info_ordermessage']; ?><?php echo $lang['feiwa_colon'];?></dt>
        ...
        <div class="contact-info">
          <h4>发货信息</h4>
          <dl>
            <dt>物流公司<?php echo $lang['feiwa_colon'];?></dt>
            <dd><?php echo $output['express_info']['e_name']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_shipping_code'];?><?php echo $lang['feiwa_colon'];?></dt>
            <dd><?php echo $output['order_info']['point_shippingcode']; ?></dd>
            <dt><?php echo $lang['admin_pointorder_shipping_time'];?><?php echo $lang['feiwa_colon'];?></dt>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td class="w30"><div class="goods-thumb"><a href="<?php echo urlMall('pointprod', 'pinfo', array('id' => $v['point_goodsid']));?>" target="_blank" class="order_info_pic"> <img src="<?php echo $v['point_goodsimage_small'];?>"/></a></div></td>
                <td style="text-align: left;"><a href="<?php echo urlMall('pointprod', 'pinfo', array('id' => $v['point_goodsid']));?>" target="_blank"><?php echo $v['point_goodsname'];?></a></td>
          ...
          <div class="total-amount">
            <h3><?php echo $lang['admin_pointorder_exchangepoints'];?><?php echo $lang['feiwa_colon'];?><strong class="red_common"><?php echo $output['order_info']['point_allpoint'];?></strong></h3>
            <?php if ($output['order_info']['point_shippingcharge'] == 1){ ?>
            <h4>(<?php echo $lang['admin_pointorder_shippingfee'];?><?php echo $lang['feiwa_colon'];?><?php echo $output['order_info']['point_shippingfee'];?>)</h4>
            <?php } ?>
          </div>
        </div>
      </div>
