...
<div class="page">
  ...
  <form method="post" name="form1" id="form1" action="index.php?app=vr_bill&feiwa=bill_pay&ob_id=<?php echo $_GET['ob_id'];?>">
    ...
    <div class="ncap-form-default">
      ...
      <div class="bot"><a href="JavaScript:void(0);" id="ncsubmit" class="ncap-btn-big ncap-btn-green"><?php echo $lang['feiwa_submit'];?></a></div>
    </div>
  </form>
</div>
