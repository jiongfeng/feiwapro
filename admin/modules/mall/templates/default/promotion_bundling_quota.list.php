...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['feiwa_promotion_bundling'];?></h3>
        <h5><?php echo $lang['feiwa_promotion_bundling_subhead'];?></h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="index.php?app=promotion_bundling&feiwa=bundling_list"><?php echo $lang['bundling_list'];?></a></li>
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['bundling_quota'];?></a></li>
        <li><a href="index.php?app=promotion_bundling&feiwa=bundling_setting"><?php echo $lang['bundling_setting'];?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=promotion_bundling&feiwa=bundling_quota_xml',
        colModel: [
