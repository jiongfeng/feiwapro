...
<ul class="dialog-goodslist-s2">
  ...
  <li>
    <div onclick="select_recommend_goods(<?php echo $v['goods_id'];?>);" class="goods-pic"><span class="ac-ico"></span><span class="thumb size-72x72"><i></i>
        ...
        title="<?php echo $v['goods_name'];?>" goods_name="<?php echo $v['goods_name'];?>" goods_jingle="<?php echo $v['goods_jingle'];?>" src="<?php echo thumb($v, 240);?>" onload="javascript:DrawImage(this,72,72);" /></span></div>
...
<?php }else { ?>
<p class="no-record"><?php echo $lang['feiwa_no_record'];?></p>
<?php } ?>
<div class="clear"></div>
