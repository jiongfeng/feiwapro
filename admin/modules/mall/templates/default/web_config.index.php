  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="60" align="center"><?php echo $lang['feiwa_display'];?></th>
        <th></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td class="handle"><a class="btn purple" href="index.php?app=web_config&feiwa=web_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-cog"></i><?php echo $lang['web_config_web_edit'];?></a><a class="btn orange" href="index.php?app=web_config&feiwa=code_edit&web_id=<?php echo $v['web_id'];?>"><i class="fa fa-steam"></i><?php echo $lang['web_config_code_edit'];?></a></td>
        ...
        <td><?php echo $v['web_show']==1 ? '<span class="yes"><i class="fa fa-check-circle"></i>'.$lang['feiwa_yes'].'</span>' : '<span class="no"><i class="fa fa-ban"></i>'.$lang['feiwa_no'].'</span>';?></td>
        <td></td>
      </tr>
      <?php } ?>
      <?php }else { ?>
