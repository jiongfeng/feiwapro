...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=store&feiwa=store_joinin" title="返回<?php echo $lang['pending'];?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['feiwa_store_manage'];?> - 查看会员“<?php echo $output['joinin_detail']['member_name'];?>”的店铺注册信息</h3>
  ...
  <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
    ...
    <tbody>
      <tr>
        <th class="w150">营业执照号：<br>（个人入驻身份证号）</th>
  ...
  <form id="form_store_verify" action="index.php?app=store&feiwa=store_joinin_verify" method="post">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
          <?php 
           $hetong = explode('|', $output['joinin_detail']['hetong']);
           foreach ($hetong as $key => $value) {
            if($value!=""){
          ?>
           <a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($value);?>"> 
              <img src="<?php echo getStoreJoininImageUrl($value);?>" alt="" /> 
            </a>
          <?php
            }
           }
