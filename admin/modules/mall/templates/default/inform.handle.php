...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=inform&feiwa=inform_list" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
  ...
  <form id="handle_form" method="post"  action="index.php?app=inform&feiwa=inform_handle" name="form1">
    ...
    <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="btn_handle_submit"><?php echo $lang['feiwa_submit'];?></a></div>
    </dl>
  </form>
</div>
