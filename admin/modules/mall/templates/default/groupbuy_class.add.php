...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="index.php?app=groupbuy&feiwa=class_list" title="返回列表">
        <i class="fa fa-arrow-circle-o-left"></i>
      </a>
      <div class="subject">
        <h3><?php echo $lang['groupbuy_index_manage']; ?> - 新增团购分类</h3>
        <h5>商家可设置其团购活动的分类以便于会员检索</h5>
      </div>
    </div>
  </div>
  <form id="add_form" method="post" action="index.php?app=groupbuy&feiwa=class_save">
