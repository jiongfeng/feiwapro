  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminMall('delivery', 'index');?>" <?php if ($output['sign'] != 'verify') {?>class="current"<?php }?>><?php echo $lang['feiwa_manage'];?></a></li>
        <li><a href="<?php echo urlAdminMall('delivery', 'index', array('sign' => 'verify'));?>" <?php if ($output['sign'] == 'verify') {?>class="current"<?php }?>>等待审核</a></li>
        <!-- <li><a href="<?php echo urlAdminMall('delivery', 'setting');?>">设置</a></li> -->
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=delivery&feiwa=index_xml&sign=<?php echo $output['sign']; ?>',
        colModel: [
