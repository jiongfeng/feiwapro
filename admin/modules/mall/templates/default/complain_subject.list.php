  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr class="hover">
        ...
        <td class="handle-s"><a class="btn red" href="<?php echo urlAdminMall('complain', 'complain_subject_drop', array('complain_subject_id' => $v['complain_subject_id']));?>" onclick="if(confirm('删除后将不能恢复，确认删除这  1 项吗？')){return true;} else {return false;}"><i class="fa fa-trash-o"></i>删除</a></td>
...
<script type="text/javascript">
    ...
    function fg_operation(name, grid) {
        if (name == 'add') {
            window.location.href = 'index.php?app=complain&feiwa=complain_subject_add';
        }
    }
</script>