  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        ...
        <li><a href="index.php?app=store_joinin&feiwa=join_setting" ><?php echo '合同与汇款';?></a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <table class="flex-table">
    <thead>
      <tr>
        ...
        <th width="80" align="center"><?php echo $lang['feiwa_sort'];?></th>
    ...
    <tbody>
      ...
      <tr data-id="<?php echo $val['help_id'];?>">
        ...
        <td class="handle-s"><a class="btn blue" href="index.php?app=store_joinin&feiwa=edit_help&help_id=<?php echo $val['help_id'];?>"><i class="fa fa-pencil-square-o"></i><?php echo $lang['feiwa_edit'];?></a></td>
