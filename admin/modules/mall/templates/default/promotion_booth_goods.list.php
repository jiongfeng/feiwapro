...
<?php if ($output['store_info']) { ?>
      <a class="back" href="index.php?app=promotion_booth&feiwa=booth_quota_list" title="返回套餐列表">
        <i class="fa fa-arrow-circle-o-left"></i>
      </a>
      <div class="subject">
        <h3><?php echo $lang['feiwa_promotion_booth']; ?> - 查看/管理店铺“<?php echo $output['store_info']['store_name']; ?>”参与活动的商品</h3>
        <h5><?php echo $lang['feiwa_promotion_booth_subhead']; ?></h5>
      </div>
<?php } else { ?>
      <div class="subject">
        <h3><?php echo $lang['feiwa_promotion_booth'];?></h3>
        <h5><?php echo $lang['feiwa_promotion_booth_subhead'];?></h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="JavaScript:void(0);" class="current">商品列表</a></li>
        <li><a href="<?php echo urlAdminMall('promotion_booth', 'booth_quota_list');?>">套餐列表</a></li>
        <li><a href="<?php echo urlAdminMall('promotion_booth', 'booth_setting');?>"><?php echo $lang['feiwa_config'];?></a></li>
      </ul>
<?php } ?>
    </div>
  </div>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=promotion_booth&feiwa=goods_list_xml&store_id=<?php echo $output['store_id']; ?>',
        colModel: [
        ...
        buttons: [
            {
                ...
                onpress: function() {
                    ...
                    var href = '<?php echo urlAdminMall('promotion_booth', 'del_goods', array(
                        'goods_id' => '__IDS__',
