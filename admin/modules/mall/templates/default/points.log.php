...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['feiwa_member_pointsmanage']?></h3>
        <h5><?php echo $lang['feiwa_member_pointsmanage_subhead']?></h5>
      </div>
      <ul class="tab-base nc-row">
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['admin_points_log_title'];?></a></li>
        <li><a href="index.php?app=points&feiwa=setting">规则设置</a></li>
        <li><a href="index.php?app=points&feiwa=addpoints">积分增减</a></li>
      </ul>
    </div>
  </div>
  <!-- 操作说明 -->
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?app=points&feiwa=get_xml',
        colModel : [
