...
<div class="page">
  ...
  <div id="stat_tabs" class="  ui-tabs" style="min-height:500px">
    <ul class="tab-base nc-row">
      ...
      <li><a href="#goodsnum_div" feiwa_type="showdata" data-param='{"type":"goodsnum"}'>下单量</a></li>
    </ul>
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="app" value="stat_goods" />
...
function getStatdata(type){
	...
	$('#'+type+'_div').load('index.php?app=stat_goods&feiwa=hotgoods_list&type='+type+'&choose_gcid='+choose_gcid+'&t=<?php echo $output['searchtime'];?>');
}
