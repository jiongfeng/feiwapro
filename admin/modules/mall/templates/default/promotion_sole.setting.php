...
<div class="page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminMall('promotion_sole', 'goods_list');?>">商品列表</a></li>
  ...
  <form id="add_form" method="post" action="<?php echo urlAdminMall('promotion_sole', 'sole_setting');?>">
