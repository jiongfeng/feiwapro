...
<div class="page">
  ...
  <div id="stat_tabs" class="  ui-tabs" style="min-height:500px">
    <ul class="tab-base nc-row">
      <li><a href="#membernum_div" feiwa_type="showmap" data-param='{"type":"membernum"}'>下单会员数</a></li>
      <li><a href="#ordernum_div" feiwa_type="showmap" data-param='{"type":"ordernum"}'>下单量</a></li>
      <li><a href="#orderamount_div" feiwa_type="showmap" data-param='{"type":"orderamount"}'>下单金额</a></li>
    </ul>
  ...
  <div class="ncap-search-bar">
    ...
    <form method="get" action="index.php" name="formSearch" id="formSearch">
      <input type="hidden" name="app" value="stat_member" />
...
$(function () {
	...
	$("[name='searchweek_month']").change(function(){
		...
		$.getJSON('<?php echo ADMIN_SITE_URL?>/index.php?app=common&feiwa=getweekofmonth',{y:year,m:month},function(data){
	        if(data != null){
    ...
    $("[feiwa_type='showmap']").click(function(){
    ...
    //加载统计列表
    $("#statlist").flexigrid({
        url: 'index.php?app=stat_member&feiwa=get_arealist_xml&t=<?php echo $output['searchtime'];?>',
        colModel : [
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_member&feiwa=area_list&exporttype=excel&t=<?php echo $output['searchtime'];?>';
    get_excel(stat_url,bDiv);
}
//加载统计地图
function getStatMap(type){
	$('#'+type+'_div').load('index.php?app=stat_member&feiwa=area_map&type='+type+'&t=<?php echo $output['searchtime'];?>');
}
</script>