...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <a class="back" href="<?php echo urlAdminMall('pointprod', 'pointorder_list'); ?>" title="返回列表">
  ...
  <form id="ship_form" method="post" name="ship_form" action="index.php?app=pointprod&feiwa=order_ship&id=<?php echo $_GET['id']; ?>">
  ...
  <div class='msgdiv'> <?php echo $output['errormsg']; ?> <br>
    <br>
    <a class="forward" href="index.php?app=pointprod&amp;feiwa=pointorder_list"><?php echo $lang['admin_pointorder_gobacklist']; ?></a> </div>
  <?php } ?>
</div>
