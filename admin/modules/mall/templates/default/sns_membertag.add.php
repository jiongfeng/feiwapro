  ...
  <form id="membertag_form" method="post" enctype="multipart/form-data">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="mtag_recommend1" class="cb-enable"><?php echo $lang['feiwa_yes'];?></label>
            <label for="mtag_recommend0" class="cb-disable selected"><?php echo $lang['feiwa_no'];?></label>
