  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="<?php echo urlAdminMall('delivery', 'index');?>"><?php echo $lang['feiwa_manage'];?></a></li>
        <li><a href="<?php echo urlAdminMall('delivery', 'index', array('sign' => 'verify'));?>">等待审核</a></li>
        <li><a href="javascript:void(0);" class="current">设置</a></li>
      </ul>
    </div>
  </div>
  <form id="setting_form" method="post" action="<?php echo urlAdminMall('delivery', 'save_setting');?>">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          ...
          <p class="notic">现在去设置物流自提服务站使用的快递公司，<a onclick="window.parent.openItem('mall|express');" href="JavaScript:void(0);" class="ncap-btn"><i class="fa fa-truck"></i>
快递公司</a></p>
        </dd></dl>
        
      <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['feiwa_submit'];?></a></div></div>
  </form>
</div>
<script>
$(function(){
