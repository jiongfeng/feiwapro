...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=web_config&feiwa=web_config" title="返回<?php echo '板块区';?>列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['web_config_index'];?> - 设计“<?php echo $output['web_array']['web_name']?>”板块</h3>
        <h5><?php echo $lang['feiwa_web_index_subhead'];?></h5>
      </div>
    </div>
  </div>
  <!-- 操作说明 -->
  ...
  <div class="ncap-form-all">
    <div class="title">
      ...
      <a href="index.php?app=web_config&feiwa=web_edit&web_id=<?php echo $output['web_array']['web_id'];?>">设置该板块色彩</a> </div>
    <dl class="row">
      <dt class="tit">
        <label><?php echo $lang['web_config_edit_html'].$lang['feiwa_colon'];?></label>
      </dt>
      <dd class="opt">
          ...
          <div class="left">
            <dl id="left_tit">
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_tit');"><i class="fa fa-pencil-square-o"></i><?php echo $lang['feiwa_edit'];?></a></dt>
              ...
              <dt>
                ...
                <a href="JavaScript:show_dialog('upload_act');"><i class="fa fa-picture-o"></i><?php echo $lang['feiwa_edit'];?></a></dt>
              <dd class="act-pic">
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('category_list');"><i class="icon-th"></i><?php echo $lang['feiwa_edit'];?></a></dt>
            ...
            <dl>
              <dt>
                ...
                <a href="JavaScript:show_dialog('brand_list');"><i class="icon-ticket"></i><?php echo $lang['feiwa_edit'];?></a></dt>
              <dd>
                <ul class="brands">
            ...
            <div>
              ...
              <dl recommend_id="<?php echo $key;?>">
                <dt>
                  ...
                  <a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="fa fa-trash"></i><?php echo $lang['feiwa_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="fa fa-mallping-cart"></i><?php echo '商品块';?></a> <a href="JavaScript:show_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a> </dt>
                <dd>
                  ...
                  <div class="middle-banner"> 
                  	<a href="javascript:void(0);" class="feiwa-hd-a">
                  <img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>" title="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>"/></a>
<a href="javascript:void(0);" class="feiwa-hd-b">
                  <img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" stitle="<?php echo $val['pic_list']['11']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a> <a href="javascript:void(0);" class="feiwa-hd-c">
                  <img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>" title="<?php echo $val['pic_list']['12']['pic_name'];?>" stitle="<?php echo $val['pic_list']['12']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>"/></a>  
                  <a href="javascript:void(0);" class="feiwa-hdd-a">
                  <img pic_url="<?php echo $val['pic_list']['21']['pic_url'];?>" title="<?php echo $val['pic_list']['21']['pic_name'];?>" stitle="<?php echo $val['pic_list']['21']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['21']['pic_img'];?>"/></a> 
                  <a href="javascript:void(0);" class="feiwa-hdd-b">
                  <img pic_url="<?php echo $val['pic_list']['24']['pic_url'];?>" title="<?php echo $val['pic_list']['24']['pic_name'];?>" stitle="<?php echo $val['pic_list']['24']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['24']['pic_img'];?>"/></a> 
                  <a href="javascript:void(0);" class="left-a">
                  <img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" stitle="<?php echo $val['pic_list']['31']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>"/></a> 
                  <a href="javascript:void(0);" class="left-b">
                  <img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" stitle="<?php echo $val['pic_list']['32']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>"/></a>
                  <a href="javascript:void(0);" class="left-c">
                  <img pic_url="<?php echo $val['pic_list']['33']['pic_url'];?>" title="<?php echo $val['pic_list']['33']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['33']['pic_img'];?>"/></a> 
                  <a href="javascript:void(0);" class="left-d">
                  <img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>" title="<?php echo $val['pic_list']['34']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>"/></a>
                  </div>
                  <?php }else { ?>
                  <ul class="goods-list">
          ...
          <div class="feiwa-topbanner">
            
            <dl>
              <dt>
                <h4><?php echo '楼层底部切换广告，有则显示没有则不显示';?></h4>
                <a href="JavaScript:show_dialog('upload_adv');"><?php echo $lang['feiwa_edit'];?></a></dt>
              <dd class="adv-pic">
  ...
  <div class="bot"><a href="index.php?app=web_config&feiwa=web_html&web_id=<?php echo $_GET['web_id'];?>" class="ncap-btn-big ncap-btn-green" id="submitBtn"><?php echo $lang['web_config_web_html'];?></a> </div>
</div>
...
<div id="upload_tit_dialog" style="display:none;">
  ...
  <form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=upload_pic" target="upload_pic">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit"><?php echo $lang['web_config_upload_type'].$lang['feiwa_colon'];?></dt>
        <dd class="opt">
      ...
      <dl id="upload_tit_type_pic" class="row" <?php if($output['code_tit']['code_info']['type'] == 'txt'){ ?>style="display:none;"<?php } ?>>
        <dt class="tit"><?php echo $lang['web_config_upload_tit'].$lang['feiwa_colon'];?></dt>
        <dd class="opt">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_tit_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['feiwa_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 推荐分类模块 -->
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
  ...
  <form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=upload_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    ...
    <div class="ncap-form-default" id="upload_act_type_pic" <?php if($output['code_act']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['web_config_upload_url'].$lang['feiwa_colon'];?></label>
        </dt>
        <dd class="opt">
          <input name="act[url]" value="<?php echo !empty($output['code_act']['code_info']['url']) ? $output['code_act']['code_info']['url']:MALL_SITE_URL;?>" class="input-txt" type="text">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="act[urla]" value="<?php echo !empty($output['code_act']['code_info']['urla']) ? $output['code_act']['code_info']['urla']:MALL_SITE_URL;?>" class="input-txt" type="text">
          <p class="notic"><?php echo $lang['web_config_upload_act_url'];?></p>
        </dd>
      </dl>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input name="act[urlb]" value="<?php echo !empty($output['code_act']['code_info']['urlb']) ? $output['code_act']['code_info']['urlb']:MALL_SITE_URL;?>" class="input-txt" type="text">
          <p class="notic"><?php echo $lang['web_config_upload_act_url'];?></p>
        </dd>
      </dl>
      <dl class="row">
      ...
      <div class="bot"><a href="JavaScript:void(0);" onclick="$('#upload_act_form').submit();" class="ncap-btn-big ncap-btn-green"><?php echo $lang['feiwa_submit'];?></a></div>
    </div>
  </form>
</div>
<!-- 商品推荐模块 -->
        ...
        <dd class="opt">
          <ul class="dialog-goodslist-s1 goods-list">
            ...
            <li id="select_recommend_<?php echo $key;?>_goods_<?php echo $k;?>">
              ...
              <div class="goods-name"><a href="<?php echo MALL_SITE_URL."/index.php?app=goods&goods_id=".$v['goods_id'];?>" target="_blank"><?php echo $v['goods_name'];?></a></div>
            ...
            <li id="select_recommend_<?php echo $key;?>_pic_<?php echo $k;?>" style="display:none;">
             ...
             <input name="recommend_list[<?php echo $key;?>][pic_list][<?php echo $v['pic_id'];?>][pic_sname]" value="<?php echo $v['pic_sname'];?>" type="hidden">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_goods();" class="ncap-btn"><?php echo $lang['feiwa_query'];?></a></div>
...
<div id="recommend_pic_dialog" style="display:none;">
  ...
  <form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=recommend_pic" target="upload_pic">
    <input type="hidden" name="form_submit" value="ok" />
    <input type="hidden" name="web_id" value="<?php echo $output['code_recommend_list']['web_id'];?>">
    <input type="hidden" name="code_id" value="<?php echo $output['code_recommend_list']['code_id'];?>">
...
<a recommend_pic_id="14" href="javascript:void(0);" class="feiwa-hd-a">
	<img pic_url="<?php echo $val['pic_list']['14']['pic_url'];?>" title="<?php echo $val['pic_list']['14']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['14']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['14']['pic_img'];?>" stitle="<?php echo $val['pic_list']['14']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['14']['pic_sname'];?>"/></a>
          <a recommend_pic_id="11" href="javascript:void(0);" class="feiwa-hd-b">
          	<img pic_url="<?php echo $val['pic_list']['11']['pic_url'];?>" title="<?php echo $val['pic_list']['11']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['11']['pic_name'];?>" pic_sname="<?php echo $val['pic_list']['11']['pic_sname'];?>" stitle="<?php echo $val['pic_list']['11']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['11']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['11']['pic_sname'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['11']['pic_img'];?>"/></a> 
          <a recommend_pic_id="12" href="javascript:void(0);" class="feiwa-hd-c">
          	<img pic_url="<?php echo $val['pic_list']['12']['pic_url'];?>" title="<?php echo $val['pic_list']['12']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['12']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['12']['pic_img'];?>" stitle="<?php echo $val['pic_list']['12']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['12']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="21" href="javascript:void(0);" class="feiwa-hdd-a">
          	<img pic_url="<?php echo $val['pic_list']['21']['pic_url'];?>" title="<?php echo $val['pic_list']['21']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['21']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['21']['pic_img'];?>" stitle="<?php echo $val['pic_list']['21']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['21']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="24" href="javascript:void(0);" class="feiwa-hdd-b">
          	<img pic_url="<?php echo $val['pic_list']['24']['pic_url'];?>" title="<?php echo $val['pic_list']['24']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['24']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['24']['pic_img'];?>" stitle="<?php echo $val['pic_list']['24']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['24']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="31" href="javascript:void(0);" class="left-a">
          	<img pic_url="<?php echo $val['pic_list']['31']['pic_url'];?>" title="<?php echo $val['pic_list']['31']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['31']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['31']['pic_img'];?>" stitle="<?php echo $val['pic_list']['31']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['31']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="32" href="javascript:void(0);" class="left-b">
          	<img pic_url="<?php echo $val['pic_list']['32']['pic_url'];?>" title="<?php echo $val['pic_list']['32']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['32']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['32']['pic_img'];?>" stitle="<?php echo $val['pic_list']['32']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['32']['pic_sname'];?>"/></a> 
   <a recommend_pic_id="33" href="javascript:void(0);" class="left-c">
   	<img pic_url="<?php echo $val['pic_list']['33']['pic_url'];?>" title="<?php echo $val['pic_list']['33']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['33']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['33']['pic_img'];?>" stitle="<?php echo $val['pic_list']['33']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['33']['pic_sname'];?>"/></a> 
          <a recommend_pic_id="34" href="javascript:void(0);" class="left-d">
          	<img pic_url="<?php echo $val['pic_list']['34']['pic_url'];?>" title="<?php echo $val['pic_list']['34']['pic_name'];?>" pic_name="<?php echo $val['pic_list']['34']['pic_name'];?>" src="<?php echo UPLOAD_SITE_URL.'/'.$val['pic_list']['34']['pic_img'];?>" stitle="<?php echo $val['pic_list']['34']['pic_sname'];?>" pic_sname="<?php echo $val['pic_list']['34']['pic_sname'];?>"/></a> </div>
          <?php } ?>
          <?php } ?>
          <?php } ?>
        </dd>
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input class="input-txt" type="text" name="pic_list[pic_url]" value="<?php echo MALL_SITE_URL;?>">
        </dd>
      </dl>
      <dl class="row">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div class="search-bar">
            ...
            <a href="JavaScript:void(0);" onclick="get_recommend_brand();" class="ncap-btn"><?php echo $lang['feiwa_query'];?></a> </div>
...
<div id="upload_adv_dialog" class="upload_adv_dialog" style="display:none;">
  ...
  <form id="upload_adv_form" name="upload_adv_form" enctype="multipart/form-data" method="post" action="index.php?app=web_config&feiwa=slide_adv" target="upload_pic">
    ...
    <div id="upload_slide_adv" class="ncap-form-default" style="display:none;">
      ...
      <dl class="row">
        <dt class="tit"><?php echo $lang['web_config_upload_adv_pic'].$lang['feiwa_colon'];?></dt>
        <dd class="opt">
          <div class="input-file-show"><span class="type-file-box">
            <input type='text' name='textfield' id='textfield1' class='type-file-text' />
            <input type='button' name='button' id='button1' value='选择上传...' class='type-file-button' />
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <style>
          .inputFileWrapper label{ display: block; float: left; position: relative; }
          .inputFileWrapper input[type="file"]{position: absolute; width: 1px; height: 1px; clip:rect(0,0,0,0); }
          .inputFileWrapper .custorm-style{ display: block;  width: 390px; height: 50px; }
          .inputFileWrapper .custorm-style .left-button{ width: 80px; line-height: 50px; background: #008ac7; color: #fff; display: block; text-align: center; float: left; }
          .inputFileWrapper .custorm-style .right-text{ width: 300px; height: 40px; line-height: 50px; display: block; float: right; padding: 4px; border: 1px solid #008ac7; overflow: hidden; -ms-text-overflow: ellipsis; text-overflow: ellipsis; white-space: nowrap; }
          .custorm-style{ background-color: #fff; border: 1px solid #d7d7d7; border-radius: 4px; display: inline-block; padding-left: 26px; position: relative; vertical-align: top; z-index: 1; height: 26px !important; width: 262px !important; }
          .custorm-style:hover{border-color: #2cbca3 !important;box-shadow: 0 0 5px rgba(44, 188, 163, 0.5)!important;}
          .custorm-style:hover .left-button{ background-color: #2cbca3 !important;color: #fff !important; }
          .left-button{float: right !important; height: 26px !important; line-height: 26px !important;background-color: #e6e6e6 !important;display: block;width: 99px !important;border: 0;border-radius: 0 3px 3px 0; color: #333 !important; cursor: pointer;} 
          .right-text{cursor: pointer;height: 20px !important; line-height: 20px !important; opacity: 1; position: absolute; left: -26px; top: 0; width: 153px !important; margin-left: 26px !important;border: none !important;}
          </style>
          <script>
              var fileBtn = $("#pic_simg");
          ...
          <input name="slide_pic[pic_simg]" value="" class="input-txt" type="hidden">
          <div class="inputFileWrapper">
              <label for="pic_simg">
                  <input name="pic_simg" id="pic_simg" type="file">
                  <span class="custorm-style">
                      <div style="display: block;height: 26px;position: relative; width: 262px; z-index: 1;">
                        <span class="left-button">选择上传...</span>
          ...
          <p style="margin-top:40px;"><img src="" style="max-height: 112px;max-width: 106px;" id="image2"></p>
          <p class="notic"><?php echo $lang['web_config_adv_url_tips'];?></p>
        </dd>
        <!-- liuxuexin end -->
      </dl>
