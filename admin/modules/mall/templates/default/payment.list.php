...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?php echo $lang['feiwa_pay_method'];?></h3>
        <h5><?php echo $lang['feiwa_pay_method_subhead'];?></h5>
      </div>
    </div>
  </div>
  ...
  <table class="flex-table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="handle-s"><a class="btn purple" href="index.php?app=payment&feiwa=edit&payment_id=<?php echo $v['payment_id']; ?>"><i class="fa fa-cog"></i><?php echo $lang['feiwa_set']?></a></td>
