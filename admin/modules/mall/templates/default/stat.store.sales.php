...
function getTrends(storeid){
	var s_type = $("#search_type").val();
	$('#stattrends').load('index.php?app=stat_store&feiwa=storesales_trends&storeid='+storeid+'&search_type='+s_type+'&'+$("#formSearch").serialize());
}
function update_flex(){
    $('#stattrends').html('');
    $("#flexigrid").flexigrid({
        url: 'index.php?app=stat_store&feiwa=get_storesales_xml&'+$("#formSearch").serialize(),
        colModel : [
...
$(function () {
    ...
    //店铺销售走势
    $("[feiwa_type='showtrends']").live('click',function(){
...
function fg_operation(name, bDiv){
    var stat_url = 'index.php?app=stat_store&feiwa=storesales_list';
