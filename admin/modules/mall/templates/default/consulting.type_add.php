...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=consulting&feiwa=type_list" title="返回咨询类型列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['consulting_index_manage'];?> - <?php echo $lang['feiwa_new'];?></h3>
