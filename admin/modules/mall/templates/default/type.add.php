...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title"><a class="back" href="index.php?app=type&feiwa=type" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
      <div class="subject">
        <h3><?php echo $lang['feiwa_type_manage'];?> - <?php echo $lang['feiwa_new'];?></h3>
            ...
            <div class="ncap-type-spec-list">
              ...
              <dl>
                ...
                <dd>
                  ...
                  <label>
                    <input class="checkitem" feiwa_type="change_default_spec_value" type="checkbox" value="<?php echo $v['sp_id'];?>" name="spec_id[]">
