...
<div class="page">
  ...
  <form id="post_form" method="post" name="form1" action="index.php?app=refund&feiwa=edit_reason&reason_id=<?php echo $output['reason']['reason_id']; ?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="sort"><em>*</em><?php echo $lang['feiwa_sort'];?></label>
        </dt>
        <dd class="opt">
