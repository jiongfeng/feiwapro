...
<div class="store-select-box">
    ...
    <ul id="store_search_list" class="store-search-list">
        ...
        <dl class="store-info">
            <dt class="store-name">
            <a href="<?php echo urlMall('show_store', 'index', array('store_id'=>$value['store_id']));?>"  >
            ...
            <dd nctype="btn_store_select" class="handle-button" title="<?php echo $lang['reads_text_add'];?>"></dd>
        </dl>
        </li>
        <?php } ?>
    </ul>
