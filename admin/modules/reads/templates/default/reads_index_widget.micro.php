...
$(document).ready(function() {
    ...
    var control_html = '<div id="indexPersonalControl" nctype="reads_index_not_save">';
...
<div class="reads-index-module-micro">
  ...
  <div class="reads-index-module-handle"><a id="btn_module_micro_edit" href="JavaScript:void(0);" class="tip-r" title="<?php echo $lang['reads_index_module_micro_edit'];?>"><?php echo $lang['reads_index_module_micro_edit'];?></a></div>
  <?php } ?>
</div>
