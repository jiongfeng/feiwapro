...
<div class="member-select-box">
    ...
    <ul id="member_search_list" class="member-search-list">
        ...
        <dl class="member-info">
            ...
            <a href="<?php echo MALL_SITE_URL.DS;?>index.php?app=member_snshome&mid=<?php echo $value['member_id'];?>" target="_blank">
            ...
            <dd nctype="btn_member_select" class="handle-button" title="<?php echo $lang['reads_text_add'];?>"></dd>
        </dl>
        </li>
        <?php } ?>
    </ul>
