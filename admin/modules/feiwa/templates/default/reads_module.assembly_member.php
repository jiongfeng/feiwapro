...
<!-- 店铺　-->
<div class="reads-module-assembly-member">
    <div class="title-bar">
    ...
    <div class="content-box">
        ...
        <?php echo "<?php if(\$output['edit_flag']) { ?>";?>
        <div class="reads-index-module-handle"><a nctype="btn_module_member_edit" href="JavaScript:void(0);" class="tip-l" title="<?php echo $lang['reads_index_module_member_edit'];?>"><?php echo $lang['reads_index_module_member_edit'];?></a></div>
        <?php echo "<?php } ?>";?>
    </div>
</div>
