        ...
        if(chksubmit()){
            ...
            if($result){
                ...
                if(intval($_POST['c_isuse']) == 1){
                    $this->log(L('feiwa_circle_open'));
                }else{
                    $this->log(L('feiwa_circle_close'));
                }
...
Tpl::showpage('circle_setting.adv');
    ...
    public function superaddFeiwa() {
        if (chksubmit()) {
            ...
            if ($result) {
                showMessage(L('feiwa_common_op_succ'), urlAdminCircle('circle_setting', 'super_list'));
            } else {
                showMessage(L('feiwa_common_op_fail'));
            }
        }
...
Tpl::showpage('circle_setting.super_add');
     ...
     * 超级管理列表
     */
    public function super_listFeiwa() {
        ...
        if (chksubmit()) {
            ...
            if ($result) {
                showMessage(L('feiwa_common_del_succ'));
            } else {
                showMessage(L('feiwa_common_del_fail'));
            }
        }
...
Tpl::showpage('circle_setting.super_list');
     ...
     * 选择超管
     */
    public function choose_superFeiwa(){
...
Tpl::showpage('circle.choose_master', 'null_layout');
     ...
     * 删除超级管理员
     */
    public function del_superFeiwa() {
     ...
     * 搜索会员
     */
    public function member_searchFeiwa() {
