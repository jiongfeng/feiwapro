  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="JavaScript:void(0);" class="current"><?php echo $lang['feiwa_circle_setting'];?></a></li>
        <li><a href="index.php?app=circle_setting&feiwa=seo"><?php echo $lang['circle_setting_seo'];?></a></li>
        <li><a href="index.php?app=circle_setting&feiwa=sec"><?php echo $lang['circle_setting_sec'];?></a></li>
        <li><a href="index.php?app=circle_setting&feiwa=exp"><?php echo $lang['circle_setting_exp'];?></a></li>
        <li><a href="index.php?app=circle_setting&feiwa=super_list">超级管理员</span></a></li>
      </ul>
    </div>
  </div>
