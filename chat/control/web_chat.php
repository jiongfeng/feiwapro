...
class web_chatControl extends BaseControl {
    ...
    public function send_msgFeiwa(){
        ...
        if (($member_id < 1) || ($member_id != $f_id)) $this->error(Language::get('feiwa_member_chat_login'));

        $member = $model_chat->getMember($t_id);

        if ($t_name != $member['member_name']) $this->error(Language::get('feiwa_member_chat_name_error'));
        ...
        if($chat_msg['m_id']) {
            ...
            $this->error(Language::get('feiwa_member_chat_add_error'));
    ...
    public function get_user_listFeiwa(){
    ...
    public function get_seller_listFeiwa(){
    ...
    public function get_infoFeiwa(){

        if ($_SESSION['member_id'] < 1) $this->error(Language::get('feiwa_member_chat_login'));
    ...
    public function get_chat_logFeiwa(){
    ...
    public function get_goods_infoFeiwa(){
    ...
    public function get_goods_listFeiwa(){
        ...
        if ($s_id > 0) {
            ...
            if(!empty($list) && is_array($list)) {
                ...
                foreach($list as $k => $v) {
                    ...
                    $v['url'] = urlMall('goods','index',array('goods_id'=> $v['goods_id']));
    ...
    public function get_sessionFeiwa(){
