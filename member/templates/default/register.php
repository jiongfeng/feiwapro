    ...
    <div class="nc-register-layout">
            ...
            <div id="default" class="tabs-content">
			  ...
			  <input type="hidden" id="rec_id" name="rec_id" class="text" value="<?php echo $_GET['rec'];?>"/>
                ...
                <div class="code-div mt15">
                  ...
                  <span><img src="index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>" name="codeimage" id="codeimage"/> <a class="makecode" href="javascript:void(0)" onclick="javascript:document.getElementById('codeimage').src='index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span></div>
                <?php } ?>
                <dl class="clause-div">
                  <dd>
                    <input name="agree" type="checkbox" class="checkbox" id="clause" value="1" checked="checked" />
                    <?php echo $lang['login_register_agreed'];?><a href="<?php echo urlMall('document', 'index',array('code'=>'agreement'));?>" target="_blank" class="agreement" title="<?php echo $lang['login_register_agreed'];?>"><?php echo $lang['login_register_agreement'];?></a></dd>
                </dl>
            ...
            <div id="mobile" class="tabs-content">
              <form id="post_form" method="post" class="nc-login-form">
                ...
                <div class="code-div">
                  ...
                  <span><img src="index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>" title="<?php echo $lang['login_index_change_checkcode'];?>" name="codeimage" id="sms_codeimage"><a class="makecode" href="javascript:void(0);" onclick="javascript:document.getElementById('sms_codeimage').src='index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();"><?php echo $lang['login_password_change_code']; ?></a></span> </div>
      ...
      <div class="right">
        ...
        <div class="api-login">
          <h4>使用合作网站账号直接登录</h4>
          <?php if (C('qq_isuse') == 1){?>
          <a href="<?php echo MEMBER_SITE_URL;?>/api.php?app=toqq" title="QQ账号登录" class="qq"><i></i></a>
          <?php } ?>
          <?php if (C('sina_isuse') == 1){?>
          <a href="<?php echo MEMBER_SITE_URL;?>/api.php?app=tosina" title="<?php echo $lang['feiwa_otherlogintip_sina']; ?>" class="sina"><i></i></a>
          <?php } ?>
    ...
    $("#register_form").validate({
        ...
        rules : {
            user_name : {
                ...
                letters_name : true,
                remote   : {
                    url :'index.php?app=login&feiwa=check_member&column=ok',
                    type:'get',
                    data:{
                        user_name : function(){
            ...
            email : {
                ...
                email    : true,
                remote   : {
                    url : 'index.php?app=login&feiwa=check_email',
                    type: 'get',
                    data:{
                        email : function(){
                            return $('#email').val();
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('codeimage').src='index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
		...
		rules: {
			...
			captcha : {
                ...
                remote   : {
                    ...
                    complete: function(data) {
                        if(data.responseText == 'false') {
                        	document.getElementById('sms_codeimage').src='index.php?app=seccode&feiwa=makecode&type=50,120&nchash=<?php echo getNchash();?>&t=' + Math.random();
                        }
                    }
                }
            },
