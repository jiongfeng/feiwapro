...
<div class="wrap">
  ...
  <div class="ncm-default-form">
    <dl>
      <dt><?php echo $lang['predeposit_cashsn'].$lang['feiwa_colon']; ?></dt>
      <dd><?php echo $output['info']['pdc_sn']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_cash_price'].$lang['feiwa_colon']; ?></dt>
      <dd><?php echo $output['info']['pdc_amount']; ?> <?php echo $lang['currency_zh']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_cash_shoukuanbank'].$lang['feiwa_colon']; ?></dt>
      <dd><?php echo $output['info']['pdc_bank_name']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_cash_shoukuanaccount'].$lang['feiwa_colon'];?></dt>
      <dd><?php echo $output['info']['pdc_bank_no']; ?></dd>
    </dl>
    <dl>
      <dt><?php echo $lang['predeposit_cash_shoukuanname'].$lang['feiwa_colon'];?></dt>
   ...
   <?php if (intval($output['info']['pdc_check_time'])) {?>
    <dl>
      <dt><?php echo $lang['predeposit_checktime'].$lang['feiwa_colon'];?></dt>
