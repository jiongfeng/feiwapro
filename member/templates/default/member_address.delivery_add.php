...
<div class="eject_con">
  <div class="adds">
    ...
    <div id="warning"></div>
    <form method="post" action="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_address&feiwa=delivery_add" id="address_form" target="_parent">
      ...
      <dl>
        <dt><i class="required">*</i>收货人姓名<?php echo $lang['feiwa_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>电话号码<?php echo $lang['feiwa_colon'];?></dt>
        <dd>
      ...
      <dl>
        <dt><i class="required">*</i>手机<?php echo $lang['feiwa_colon'];?></dt>
        <dd>
...
$(document).ready(function(){
	var _fuc_area = function(area_id){
		$('#zt_address').load("index.php?app=member_address&feiwa=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id="+area_id);
	}
	$("#region").feiwa_region({last_click:_fuc_area});
    ...
    $('#zt_address').load("index.php?app=member_address&feiwa=delivery_list&dlyp_id=<?php echo $output['address_info']['dlyp_id'];?>&area_id=<?php echo $output['address_info']['area_id']?>");
    <?php } ?>
});
