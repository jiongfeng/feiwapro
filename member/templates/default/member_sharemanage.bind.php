    ...
    <li>
      <div class="account-item"><span class="website-icon"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/shareicon/shareicon_<?php echo $k;?>.png"></span>
        <dl>
          ...
          <dd class="operate">
            <?php if ($v['isbind']){?>
            <em><?php echo $lang['sharebind_list_bindtime'].$lang['feiwa_colon']; ?><?php echo @date('Y-m-d',$v['snsbind_updatetime']);?></em> <a href="javascript:void(0);" feiwa_type="unbindbtn" data-param='{"apikey":"<?php echo $k;?>","apiname":"<?php echo $v['name'];?>"}'><?php echo $lang['sharebind_list_unbind'];?></a>
            <?php }else {?>
            <a class="ncbtn ncbtn-mint" feiwa_type="bindbtn" data-param='{"apikey":"<?php echo $k;?>","apiname":"<?php echo $v['name'];?>"}' href="javascript:void(0);"><?php echo $lang['sharebind_list_immediatelybind'];?></a>
            <?php }?>
          </dd>
        </dl>
      </div>
...
$(function(){
	...
	$("[feiwa_type='unbindbtn']").bind('click',function(){
		var data_str = $(this).attr('data-param');
	    eval( "data_str = "+data_str);
	    ...
	    ajax_get_confirm(confirm_tip,'<?php echo MEMBER_SITE_URL;?>/index.php?app=member_sharemanage&feiwa=unbind&type='+data_str.apikey);
	});
