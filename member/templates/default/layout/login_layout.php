...
<div class="header-wrap">
  <header class="public-head-layout wrapper">
    ...
    <?php if ($_GET['feiwa'] == 'index') {?>
    <div class="nc-regist-now">
    <span class="avatar"><img src="<?php echo getMemberAvatar(cookie('member_avatar'));?>"></span>
    <span>您好，欢迎来到<?php echo $output['setting_config']['site_name']; ?><br/><?php echo $lang['login_index_regist_now_1'];?><a title="" href="<?php echo urlMember('login', 'register', array('ref_url' => $_GET['ref_url']));?>" class="register"><?php echo $lang['login_index_regist_now_2'];?></a></span></div>
    <?php } else {?>
    <div class="nc-login-now"><?php echo $lang['login_register_login_now_1'];?><a href="<?php echo urlMember('login', 'index', array('ref_url' => $_GET['ref_url']));?>" title="<?php echo $lang['login_register_login_now'];?>" class="register"><?php echo $lang['login_register_login_now_2'];?></a></span></div>
    <?php }?>
    <?php }?>
  </header>
</div>
