  ...
  <div class="ncm-message-send">
    <div class="ncm-message-send-form">
      <div class="ncm-default-form">
        <form method="post" id="send_form" action="<?php echo MEMBER_SITE_URL;?>/index.php?app=member_message&feiwa=savemsg">
          <input type="hidden" name="form_submit" value="ok" />
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_reveiver'].$lang['feiwa_colon'];?></dt>
            <dd>
          ...
          <dl>
            <dt><i class="required">*</i><?php echo $lang['home_message_content'].$lang['feiwa_colon'];?></dt>
            <dd>
    ...
    <div class="ncm-message-send-friend">
      <h3><?php echo $lang['home_message_friend'];?></h3>
       <?php if ($output['friend_list'] != '') { ?><ul>
        ...
        <li><a href="javascript:void(0);" id="<?php echo $val['friend_tomname']; ?>" feiwa_type="to_member_name">
        ...
        <a href="index.php?app=member_snsfriend&feiwa=find" class="ncbtn-mini" target="_blank">添加好友</a>
        </div>
        <?php } ?>
    </div>
  </div>
...
$(function(){
    $('a[feiwa_type="to_member_name"]').click(function (){
