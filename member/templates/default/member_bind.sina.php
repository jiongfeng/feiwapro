...
<div class="wrap">
  ...
  <div class="ncm-bind">
    ...
    <div class="relieve">
      <form method="post" id="editbind_form" name="editbind_form" action="index.php?app=member_bind&feiwa=sinaunbind">
    ...
    <div class="revise ncm-default-form ">
      <form method="post" id="editpw_form" name="editpw_form" action="index.php?app=member_bind&feiwa=sinaunbind">
        <input type='hidden' id="is_editpw" name="is_editpw" value='yes'/>
        <dl>
          <dt><?php echo $lang['member_sconnect_modpw_newpw'].$lang['feiwa_colon']; ?></dt>
          <dd>
        ...
        <dl>
          <dt><?php echo $lang['member_sconnect_modpw_two_password'].$lang['feiwa_colon']; ?></dt>
          <dd>
    ...
    <div class="relieve pt50">
      <p class="ico"><a href="<?php echo MEMBER_SITE_URL;?>/api.php?app=tosina"><img src="<?php echo MEMBER_TEMPLATES_URL;?>/images/sina_bind_small.gif"></a></p>
